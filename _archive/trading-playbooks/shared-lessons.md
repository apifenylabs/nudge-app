...
Every piece of logic is a reusable Skill. Max 200-300 lines per skill. Single purpose. Named with version (`transform-signal-to-trade.v1.md`). Has contract: Goal → Input → Steps → Output → Dependencies.
