...
import { Check, X, ArrowRight, Zap, TrendingUp, ShieldCheck, DollarSign, Code, Users, Cpu, Globe, Layers, Star, Swords } from 'lucide-react';
...
const breadcrumbSchema = {
  ...
  '@type': 'BreadcrumbList',
  '@id': 'https://titan.apifeny.com/compare/#breadcrumb',
  itemListElement: [
    { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://titan.apifeny.com' },
    { '@type': 'ListItem', position: 2, name: 'Compare', item: 'https://titan.apifeny.com/compare' },
  ],
};
