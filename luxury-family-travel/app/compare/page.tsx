...
const ALL_DESTINATIONS = [
  { id: 'phuket-001', name: 'Amanpuri', city: 'Phuket', country: 'Thailand', category: 'Luxury Resort', ageRange: '0-16', safetyRating: 4.9, priceRange: '$$$$', popularity: 98, bestTime: 'Nov-May', amenities: ['Kids Club', 'Butler Service', 'Private Beach', 'Spa'], description: 'Aman first property, private peninsula.' },
  { id: 'tokyo-001', name: 'Aman Tokyo', city: 'Tokyo', country: 'Japan', category: 'Luxury Hotel', ageRange: '0-16', safetyRating: 4.9, priceRange: '$$$$', popularity: 98, bestTime: 'Mar-May, Oct-Nov', amenities: ['Indoor Pool', 'Spa', 'Concierge', 'Kids Welcome'], description: 'Top 6 floors of Otemachi Tower.' },
  { id: 'maldives-001', name: 'Soneva Fushi', city: 'Maldives', country: 'Maldives', category: 'Private Island', ageRange: '0-16', safetyRating: 4.8, priceRange: '$$$$', popularity: 97, bestTime: 'Nov-Apr', amenities: ['Waterslides', 'Chocolate Room', 'Observatory', 'Kids Club', 'Butler Service'], description: 'Private island, waterslides, chocolate room.' },
  { id: 'maldives-002', name: 'Velaa Private Island', city: 'Maldives', country: 'Maldives', category: 'Private Island', ageRange: '0-16', safetyRating: 4.9, priceRange: '$$$$$', popularity: 96, bestTime: 'Nov-Apr', amenities: ['Submarine', 'Private Yacht', 'Wine Cellar', 'Spa', 'Kids Club'], description: '47 villas, submarine, private yacht.' },
  { id: 'kyoto-001', name: 'Aman Kyoto', city: 'Kyoto', country: 'Japan', category: 'Luxury Resort', ageRange: '0-16', safetyRating: 4.9, priceRange: '$$$$', popularity: 96, bestTime: 'Mar-May, Oct-Nov', amenities: ['Moss Garden', 'Onsen', 'Tea Ceremony', 'Concierge'], description: '26 pavilions, 32 acres moss garden.' },
  { id: 'bali-001', name: 'Four Seasons Sayan', city: 'Bali', country: 'Indonesia', category: 'Luxury Resort', ageRange: '0-16', safetyRating: 4.9, priceRange: '$$$$', popularity: 95, bestTime: 'Apr-Oct', amenities: ['Kids Club', 'Butler Service', 'Rice Terrace', 'Spa'], description: 'Luxury in Ayung River valley.' },
  { id: 'hongkong-002', name: 'Four Seasons Hong Kong', city: 'Hong Kong', country: 'Hong Kong', category: 'Luxury Hotel', ageRange: '0-16', safetyRating: 4.9, priceRange: '$$$$', popularity: 95, bestTime: 'Oct-Dec', amenities: ['Michelin Dining', 'Infinity Pool', 'Spa', 'Concierge'], description: '2 Michelin-star Chinese, best spa.' },
  { id: 'palawan-001', name: 'Amanpulo', city: 'Palawan', country: 'Philippines', category: 'Private Island', ageRange: '0-16', safetyRating: 4.9, priceRange: '$$$$$', popularity: 95, bestTime: 'Nov-May', amenities: ['Private Beach', 'Snorkeling', 'Casita Villas', 'Spa', 'Kids Club'], description: 'Private island sanctuary.' },
  { id: 'phuket-002', name: 'Trisara', city: 'Phuket', country: 'Thailand', category: 'Luxury Resort', ageRange: '0-16', safetyRating: 4.8, priceRange: '$$$$', popularity: 94, bestTime: 'Nov-May', amenities: ['Michelin Dining', 'Private Pool', 'Spa', 'Butler Service'], description: 'Garden in Third Heaven.' },
  { id: 'hongkong-001', name: 'Mandarin Oriental Hong Kong', city: 'Hong Kong', country: 'Hong Kong', category: 'Luxury Hotel', ageRange: '0-16', safetyRating: 4.8, priceRange: '$$$$', popularity: 94, bestTime: 'Oct-Dec', amenities: ['Michelin Dining', 'Harbour View', 'Spa', 'Concierge'], description: '1963 institution, harbour views.' },
