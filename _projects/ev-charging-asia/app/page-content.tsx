...
export default function HomeContent({ meta, homepageData, blogPosts: initialPosts = [] }: { meta: Meta; homepageData: HomepageData; blogPosts?: BlogPost[] }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white dark:bg-gray-950 border-b border-gray-100 dark:border-gray-800 sticky top-[45px] z-30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
        ...
        <section className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              ...
              <div key={season} className="card-lift bg-gradient-to-br from-gray-50 to-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-all">
        ...
        {/* ═══════ ITINERARIES ═══════ */}
        <section className="bg-gradient-to-br from-sky-50 to-indigo-50 rounded-2xl p-6 sm:p-8 border border-sky-100 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link href="/itinerary/singapore-to-kuala-lumpur"
              className="group bg-white rounded-xl border border-sky-200 p-5 hover:shadow-lg hover:border-sky-400 hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {blogPosts.slice(0, 6).map((post) => (
                <Link
                  key={post.slug}
                  href={`/blog/${post.slug}`}
                  className="group bg-white rounded-xl border border-gray-200 p-5 hover:shadow-xl hover:border-emerald-300 hover:-translate-y-1 transition-all duration-300"
                >
        ...
        <section className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-6 sm:p-8 border border-amber-100 shadow-sm">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              ...
              <a
                ...
                className="group bg-white rounded-lg border border-amber-200 p-4 hover:shadow-lg hover:border-amber-300 hover:-translate-y-0.5 transition-all duration-300"
              >
          ...
          <div className="mt-4 pt-4 border-t border-amber-200">
            <p className="text-xs font-medium text-gray-700 mb-2">📊 Our Top EV-Friendly Hotel Rankings</p>
            <div className="flex flex-wrap gap-2">
              <a href="/blog/top-10-ev-friendly-hotels-thailand-2026" className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-white rounded-lg border border-amber-200 text-xs text-gray-700 hover:border-amber-400 hover:text-amber-800 transition-all">
                🇹🇭 Thailand
              </a>
              <a href="/blog/top-10-ev-friendly-hotels-in-malaysia-best-family-stays-with-ev-charging-2026" className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-white rounded-lg border border-amber-200 text-xs text-gray-700 hover:border-amber-400 hover:text-amber-800 transition-all">
                🇲🇾 Malaysia
              </a>
              <a href="/blog/top-10-ev-friendly-hotels-vietnam-best-family-stays-with-ev-charging-2026" className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-white rounded-lg border border-amber-200 text-xs text-gray-700 hover:border-amber-400 hover:text-amber-800 transition-all">
                🇻🇳 Vietnam
              </a>
              <a href="/blog" className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-amber-100 rounded-lg text-xs font-medium text-amber-800 hover:bg-amber-200 transition-all">
                View all rankings →
              </a>
            </div>
          </div>
