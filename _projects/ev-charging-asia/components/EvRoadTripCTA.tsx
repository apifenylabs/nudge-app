        ...
        {Object.entries(rentals).slice(0, 4).map(([key, r]) => (
          <a
            ...
            className={`group flex items-center gap-3 px-4 py-3 rounded-xl border transition-all duration-300 ${
              key === country
                ? 'bg-white border-sky-300 shadow-sm hover:shadow-lg hover:-translate-y-0.5'
                : 'bg-white/70 border-sky-100 hover:bg-white hover:border-sky-200 hover:shadow-md hover:-translate-y-0.5'
            }`}
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {Object.entries(rentals).slice(4).map(([key, r]) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer sponsored"
              className="group flex items-center gap-3 px-4 py-3 rounded-xl bg-white/70 border border-sky-100 hover:bg-white hover:border-sky-200 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300"
            >
              <span className="text-xl shrink-0">{r.badge}</span>
              <div className="min-w-0 flex-1">
