...
// Senior-focused posts (May 2026 thematic expansion)
import accessibleHotelsTokyoKyoto from '@/data/blog/accessible-hotels-tokyo-kyoto-seniors.json';
import seniorDiscountsSingaporeMalaysia from '@/data/blog/senior-discounts-singapore-malaysia.json';
import slowTravelBali from '@/data/blog/slow-travel-bali-seniors-guide.json';
...
const newPosts: BlogPost[] = [
  ...
  // Senior-focused posts (May 2026 thematic expansion)
  accessibleHotelsTokyoKyoto as BlogPost,
  seniorDiscountsSingaporeMalaysia as BlogPost,
