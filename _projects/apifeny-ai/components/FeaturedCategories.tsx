...
export default function FeaturedCategories() {
 ...
 <p className="text-xs sm:text-sm text-gray-500 mt-1">Browse tools by category</p>
 </div>
 ...
 className="group relative flex flex-col items-center gap-2 p-4 sm:p-5 rounded-xl border border-gray-200 bg-white transition-all duration-300 hover:border-violet-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-violet-100/50"
 >
 <div className="p-2.5 rounded-lg bg-gray-100 text-gray-600 group-hover:bg-violet-100 group-hover:text-violet-600 transition-all duration-300">
