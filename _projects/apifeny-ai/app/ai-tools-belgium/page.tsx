      ...
      <section className="border-y border-tech-500/20 bg-tech-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 max-w-4xl mx-auto">
            {[
              { title: '🇨🇦 🇧🇪 Brussels — EU Capital & Fintech Hub', description: 'Brussels is the capital of the European Union, home to EU institutions, a thriving fintech scene, and the AI4Belgium coordination. The city hosts major AI conferences and policy discussions shaping Europe\'s AI future.' },
