...
export default function AiForManufacturingPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-blue-50/20 dark:from-slate-950 dark:via-slate-900 dark:to-blue-950/10">
      <BreadcrumbSchema items={breadcrumbItems} />

      {/* Hero Section */}
      <section className="relative overflow-hidden pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/10 via-cyan-900/5 to-teal-900/10 dark:from-blue-500/10 dark:via-cyan-500/5 dark:to-teal-500/10" />
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-200 dark:border-slate-700">
                ...
                <th className="text-left py-3 font-semibold text-slate-900 dark:text-white">Category</th>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl bg-gradient-to-br from-blue-600 to-cyan-600 p-12 text-center dark:from-blue-900 dark:to-cyan-900">
