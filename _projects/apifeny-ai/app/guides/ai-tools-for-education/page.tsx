      ...
      <section className="max-w-5xl mx-auto px-4 pb-8">
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden">
          <div className="bg-gradient-to-r from-emerald-600 to-cyan-600 px-6 py-4">
            <h2 className="text-lg font-semibold text-white">Quick Comparison: Best AI Education Tools</h2>
          </div>
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {[
                  ...
                  <tr key={i} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className="inline-flex items-center gap-1 text-xs font-medium text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/50 rounded-full px-2.5 py-1">
                        <CheckCircle className="w-3 h-3" />
                        {rec.tool}
                      </span>
                    </td>
                  ...
                  {section.affiliateSuggestions.map((rec, i) => {
                    ...
                    return (
                      <a
                        ...
                        className="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 hover:border-emerald-300 dark:hover:border-emerald-700 hover:shadow-md transition-all group"
                      >
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-emerald-500 to-cyan-500 flex items-center justify-center text-white font-bold text-xs shrink-0">
