...
export default function AIToolsForHealthcareGuide() {
  return (
    <main className="min-h-screen bg-white dark:bg-gray-950">
      ...
      {/* ─── Hero ─── */}
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-700 to-violet-800 dark:from-blue-900 dark:via-indigo-950 dark:to-violet-950">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {sections.map((s) => (
              <a
                key={s.id}
                href={`#${s.id}`}
                className="flex items-center gap-2.5 text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800/50"
              >
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  ...
                  <th className="text-left px-6 py-3 font-semibold text-gray-900 dark:text-white">Key Healthcare Features</th>
                  ...
                  {s.affiliateSuggestions.map((a) => {
                    ...
                    return (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 text-xs font-medium text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 rounded-full px-3 py-1.5 hover:bg-blue-100 dark:hover:bg-blue-900/60 transition-colors"
                      >
                        {a.name}
      ...
      <section className="max-w-5xl mx-auto px-4 py-16 text-center">
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 sm:p-12">
          <Sparkles className="w-10 h-10 text-blue-600 dark:text-blue-400 mx-auto mb-4" />
