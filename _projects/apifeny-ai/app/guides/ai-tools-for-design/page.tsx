...
export default function AIToolsForDesignGuide() {
 ...
 >
 <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-gray-900 font-bold text-xs shrink-0">
