  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-950">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  <th className="text-left px-6 py-3 font-semibold text-gray-900 dark:text-white">Platform</th>
                  ...
                  <th className="text-left px-6 py-3 font-semibold text-gray-900 dark:text-white">Key AI Features</th>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/50">
                  <th className="text-left px-6 py-3 font-semibold text-gray-900 dark:text-white w-40">Platform</th>
                  <th className="text-left px-6 py-3 font-semibold text-gray-900 dark:text-white">Free Tier</th>
                  <th className="text-left px-6 py-3 font-semibold text-gray-900 dark:text-white">Starter</th>
                  <th className="text-left px-6 py-3 font-semibold text-gray-900 dark:text-white">Growth</th>
                  <th className="text-left px-6 py-3 font-semibold text-gray-900 dark:text-white">Enterprise</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                {[
                  ...
                  <tr key={i} className="hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-colors">
                    <td className="px-6 py-3 font-medium text-gray-900 dark:text-white">{row.name}</td>
                    <td className="px-6 py-3 text-gray-600 dark:text-gray-400">{row.free}</td>
                    <td className="px-6 py-3 text-gray-600 dark:text-gray-400">{row.starter}</td>
                    <td className="px-6 py-3 text-gray-600 dark:text-gray-400">{row.growth}</td>
                    <td className="px-6 py-3 text-gray-600 dark:text-gray-400">{row.enterprise}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          </div>
          <div className="px-6 py-3 bg-gray-50/50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-800">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16" id="faq">
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 sm:p-12 shadow-sm">
          ...
          <div className="space-y-6">
            {[
              ...
              >
                <summary className="flex items-start gap-3 p-4 sm:p-5 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors list-none [&::-webkit-details-marker]:hidden">
                  <HeartHandshake className="w-5 h-5 text-emerald-600 dark:text-emerald-400 mt-0.5 shrink-0" />
                  ...
                  <div className="p-4 sm:p-5 pt-0 border-t border-gray-100 dark:border-gray-800">
