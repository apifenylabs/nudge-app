...
export default function AIToolsForFinanceGuide() {
  return (
    <main className="min-h-screen bg-white dark:bg-gray-950">
      ...
      {/* ─── Hero ─── */}
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-700 via-teal-700 to-cyan-800 dark:from-emerald-900 dark:via-teal-950 dark:to-cyan-950">
      ...
      <section className="max-w-4xl mx-auto px-4 pb-12">
        <div className="bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-950/30 dark:to-cyan-950/30 border border-teal-100 dark:border-teal-900/50 rounded-xl p-6 sm:p-8">
          ...
          <div className="grid sm:grid-cols-3 gap-6 text-sm text-gray-600 dark:text-gray-400">
            <div className="space-y-2">
              <p className="font-semibold text-gray-900 dark:text-white text-base">Diverse Markets</p>
            ...
            <div className="space-y-2">
              <p className="font-semibold text-gray-900 dark:text-white text-base">Multi-Currency Reality</p>
            ...
            <div className="space-y-2">
              <p className="font-semibold text-gray-900 dark:text-white text-base">MSME Dominance</p>
          ...
          <div className="p-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                    <th className="text-left px-4 py-3 font-medium text-gray-900 dark:text-white">Platform</th>
                    <th className="text-left px-4 py-3 font-medium text-gray-900 dark:text-white">Category</th>
                    <th className="text-left px-4 py-3 font-medium text-gray-900 dark:text-white">Asia Focus</th>
                    <th className="text-left px-4 py-3 font-medium text-gray-900 dark:text-white">Starting Price</th>
                    <th className="text-left px-4 py-3 font-medium text-gray-900 dark:text-white">AI Features</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  {[
                    ...
                    <tr key={i} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                      <td className="px-4 py-3 font-medium text-gray-900 dark:text-white">{platform.name}</td>
                      <td className="px-4 py-3 text-gray-600 dark:text-gray-400">{platform.cat}</td>
                      <td className="px-4 py-3">
                        <span className="inline-flex items-center gap-1 text-xs font-medium text-teal-700 dark:text-teal-400 bg-teal-50 dark:bg-teal-950/50 rounded-full px-2 py-0.5">
                          <Globe className="w-3 h-3" />
                          {platform.focus}
                        </span>
                      </td>
                      <td className="px-4 py-3 text-gray-600 dark:text-gray-400">{platform.price}</td>
                      <td className="px-4 py-3 text-xs text-gray-500 dark:text-gray-400 max-w-[180px]">{platform.ai}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl p-6 sm:p-8">
          ...
          <div className="grid sm:grid-cols-2 gap-4 text-sm">
            <div className="p-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
              <p className="font-medium text-gray-900 dark:text-white mb-2">For Solopreneurs &amp; Freelancers</p>
              <p className="text-gray-600 dark:text-gray-400">Start with free tools like Wave or ChatGPT for basic bookkeeping and invoicing. Add Expensify for receipt tracking when your expense volume grows. Use Perplexity for tax research.</p>
            </div>
            <div className="p-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
              <p className="font-medium text-gray-900 dark:text-white mb-2">For Small Businesses (5–50 staff)</p>
              <p className="text-gray-600 dark:text-gray-400">Invest in QuickBooks or Xero with AI add-ons for full accounting automation. Add Dext for receipt processing. Use Claude for contract and document analysis.</p>
            </div>
            <div className="p-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
              <p className="font-medium text-gray-900 dark:text-white mb-2">For Asia-First Businesses</p>
              <p className="text-gray-600 dark:text-gray-400">Consider local platforms first — BukuWarung for Indonesia, Khatabook for India, FlowAccount for Thailand. Pair with Qwen or DeepSeek for localized AI financial analysis.</p>
            </div>
            <div className="p-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
              <p className="font-medium text-gray-900 dark:text-white mb-2">For Personal Finance</p>
              <p className="text-gray-600 dark:text-gray-400">Use Gemini (free) for basic budget tracking and expense categorization. Wallet by BudgetBakers or Moneyhub for multi-account tracking. ChatGPT for financial planning advice.</p>
            </div>
          </div>
        </div>
      </section>
                  ...
                  {section.affiliateSuggestions.map((rec, i) => {
                    ...
                    return (
                      <a
                        ...
                        className="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 hover:border-teal-300 dark:hover:border-teal-700 hover:shadow-md transition-all group"
                      >
