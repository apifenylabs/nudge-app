...
export default function AIToolsForProjectManagementGuide() {
 ...
 <section className="bg-gradient-to-br from-slate-100 to-blue-50 border-y border-gray-200 ">
 <div className="max-w-4xl mx-auto px-4 py-16">
 <div className="flex items-center gap-3 mb-6">
 <div className="p-2.5 rounded-xl bg-white shadow-sm border border-gray-200 ">
 <Globe className="w-5 h-5 text-gray-700 " />
 </div>
 <h2 className="text-2xl font-bold text-gray-900 ">5 Challenges AI Solves for APAC Project Managers</h2>
 </div>
