...
export default function AIToolsForPersonalFinanceGuide() {
  return (
    <main className="min-h-screen bg-white dark:bg-gray-950">
      ...
      {/* ─── Hero ─── */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-800 via-emerald-900 to-teal-950 dark:from-slate-950 dark:via-emerald-950 dark:to-teal-950">
