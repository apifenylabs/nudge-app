...
export default function AIToolsForSupplyChainGuide() {
  return (
    <main className="min-h-screen bg-white dark:bg-gray-950">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-800 via-blue-900 to-cyan-950 dark:from-slate-950 dark:via-blue-950 dark:to-cyan-950">
      ...
      <section className="max-w-5xl mx-auto px-4 pb-12">
        <div className="bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-950/30 dark:to-blue-950/30 border border-cyan-200 dark:border-cyan-800 rounded-xl p-6 sm:p-8">
          <div className="flex items-start gap-4">
            <div className="p-2.5 rounded-xl bg-cyan-100 dark:bg-cyan-900/50 shrink-0">
              <Lightbulb className="w-5 h-5 text-cyan-700 dark:text-cyan-300" />
            </div>
            <div>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Why AI for Supply Chain Right Now</h2>
      ...
      <section className="max-w-5xl mx-auto px-4 pb-8">
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden">
          <div className="bg-gradient-to-r from-slate-700 to-cyan-800 px-6 py-4">
            <h2 className="text-lg font-semibold text-white">Quick Comparison: Best AI Supply Chain Tools</h2>
          </div>
              ...
              <tbody className="divide-y divide-gray-200 dark:border-gray-800">
                {[
                  ...
                  <tr key={i} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className="inline-flex items-center gap-1 text-xs font-medium text-cyan-700 dark:text-cyan-400 bg-cyan-50 dark:bg-cyan-950/50 rounded-full px-2.5 py-1">
                        <CheckCircle className="w-3 h-3" />
                        {rec.tool}
                      </span>
                    </td>
                  ...
                  {section.affiliateSuggestions.map((rec, i) => {
                    ...
                    return (
                      <a
                        ...
                        className="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 hover:border-cyan-300 dark:hover:border-cyan-700 hover:shadow-md transition-all group"
                      >
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-cyan-600 to-blue-600 flex items-center justify-center text-white font-bold text-xs shrink-0">
      ...
      <section className="bg-gradient-to-br from-slate-100 to-cyan-50 dark:from-gray-900 dark:to-cyan-950/30 border-y border-gray-200 dark:border-gray-800">
        <div className="max-w-4xl mx-auto px-4 py-16">
          <div className="flex items-center gap-3 mb-6">
            <div className="p-2.5 rounded-xl bg-white dark:bg-gray-900 shadow-sm border border-gray-200 dark:border-gray-800">
              <Globe className="w-5 h-5 text-gray-700 dark:text-gray-300" />
            </div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">6 Challenges AI Solves for APAC Supply Chain Professionals</h2>
          </div>
