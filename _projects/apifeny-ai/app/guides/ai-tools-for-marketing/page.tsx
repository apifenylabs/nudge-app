...
export default function AIToolsForMarketingGuide() {
 ...
 {/* ─── Hero ─── */}
 <section className="relative overflow-hidden bg-gradient-to-br from-pink-600 via-rose-700 to-purple-800 ">
 ...
 <h2 className="text-lg font-semibold text-gray-900">Quick Comparison: Best AI Marketing Tools</h2>
 </div>
 ...
 className="flex items-center gap-3 p-4 rounded-xl bg-white border border-gray-200 hover:border-purple-300 hover:shadow-md transition-all group"
 >
 <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-gray-900 font-bold text-xs shrink-0">
