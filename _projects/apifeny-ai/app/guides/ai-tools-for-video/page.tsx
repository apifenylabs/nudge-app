...
export default function AIToolsForVideoGuide() {
 ...
 key={s.id}
 href={`#${s.id}`}
 className="flex items-center gap-2.5 text-sm text-gray-600 hover:text-violet-600 transition-colors p-2 rounded-lg hover:bg-gray-100 "
 >
 ...
 className="inline-flex items-center gap-1.5 text-xs font-medium text-violet-700 bg-violet-50 border border-violet-200 rounded-full px-3 py-1.5 hover:bg-violet-100 transition-colors"
 >
 {a.name}
 ...
 <div className="bg-gradient-to-br from-violet-50 to-purple-50 border border-gray-200 rounded-2xl p-8 sm:p-12">
