...
export default function AiForScienceResearchPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-indigo-50/20 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950/10">
      <BreadcrumbSchema items={breadcrumbItems} />

      {/* Hero Section */}
      <section className="relative overflow-hidden pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-900/10 via-purple-900/5 to-sky-900/10 dark:from-indigo-500/10 dark:via-purple-500/5 dark:to-sky-500/10" />
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl bg-gradient-to-br from-indigo-600 to-purple-600 p-12 text-center dark:from-indigo-900 dark:to-purple-900">
