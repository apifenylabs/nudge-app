...
export default function AiForAgriculturePage() {
 ...
 return (
 <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-green-50/20 ">
 <BreadcrumbSchema items={breadcrumbItems} />

 {/* Hero Section */}
 <section className="relative overflow-hidden pt-20 pb-16 px-4 sm:px-6 lg:px-8">
 <div className="absolute inset-0 bg-gradient-to-br from-green-900/10 via-emerald-900/5 to-teal-900/10 " />
 ...
 <div className="text-center space-y-6">
           <BreadcrumbNav
            ...
            items={[
              ...
              { label: 'AI Tools for Agriculture' },
            ]}
          />
 ...
 <div className="mx-auto max-w-4xl">
 <div className="rounded-2xl bg-gradient-to-br from-green-600 to-emerald-600 p-12 text-center ">
