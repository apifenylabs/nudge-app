...
export default function AIToolsForSalesGuide() {
 ...
 <BreadcrumbNav
        ...
        />
 <span className="inline-flex items-center gap-1.5 text-xs font-medium text-amber-200 bg-white/10 backdrop-blur-sm rounded-full px-3 py-1.5 mb-6">
 ...
 <th className="text-left px-6 py-3 font-semibold text-gray-900 ">Key Sales Features</th>
