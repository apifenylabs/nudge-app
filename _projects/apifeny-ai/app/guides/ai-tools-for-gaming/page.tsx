...
export default function AIToolsForGamingPage() {
 ...
 <td className="px-4 py-3 text-slate-600 ">Concept art, visual style</td>
 <td className="px-4 py-3"><span className="rounded-full bg-purple-100 px-2 py-0.5 text-xs text-purple-700 ">Art & 3D</span></td>
 <td className="px-4 py-3 text-slate-600 ">$</td>
 </tr>
 <tr className="hover:bg-slate-50 ">
 <td className="px-4 py-3 font-medium text-slate-900 ">Leonardo AI</td>
 <td className="px-4 py-3 text-slate-600 ">Game-ready 3D assets, PBR textures</td>
 <td className="px-4 py-3"><span className="rounded-full bg-purple-100 px-2 py-0.5 text-xs text-purple-700 ">Art & 3D</span></td>
 <td className="px-4 py-3 text-slate-600 ">$</td>
 </tr>
 <tr className="hover:bg-slate-50 ">
 <td className="px-4 py-3 font-medium text-slate-900 ">Cursor</td>
 <td className="px-4 py-3 text-slate-600 ">Unity/Unreal code assistance</td>
 <td className="px-4 py-3"><span className="rounded-full bg-blue-100 px-2 py-0.5 text-xs text-blue-700 ">Code</span></td>
 <td className="px-4 py-3 text-slate-600 ">$$</td>
 </tr>
 <tr className="hover:bg-slate-50 ">
 <td className="px-4 py-3 font-medium text-slate-900 ">GitHub Copilot</td>
 <td className="px-4 py-3 text-slate-600 ">C#/C++ completions, boilerplate</td>
 <td className="px-4 py-3"><span className="rounded-full bg-blue-100 px-2 py-0.5 text-xs text-blue-700 ">Code</span></td>
 <td className="px-4 py-3 text-slate-600 ">$</td>
 </tr>
 <tr className="hover:bg-slate-50 ">
 <td className="px-4 py-3 font-medium text-slate-900 ">Claude</td>
 <td className="px-4 py-3 text-slate-600 ">Narrative design, lore bibles</td>
 <td className="px-4 py-3"><span className="rounded-full bg-green-100 px-2 py-0.5 text-xs text-green-700 ">Narrative</span></td>
 <td className="px-4 py-3 text-slate-600 ">$$</td>
 </tr>
 <tr className="hover:bg-slate-50 ">
 <td className="px-4 py-3 font-medium text-slate-900 ">ElevenLabs</td>
 <td className="px-4 py-3 text-slate-600 ">NPC voice, multilingual VO</td>
 <td className="px-4 py-3"><span className="rounded-full bg-pink-100 px-2 py-0.5 text-xs text-pink-700 ">Audio</span></td>
 <td className="px-4 py-3 text-slate-600 ">$$</td>
 </tr>
 <tr className="hover:bg-slate-50 ">
 <td className="px-4 py-3 font-medium text-slate-900 ">Descript</td>
 <td className="px-4 py-3 text-slate-600 ">Audio editing, trailer audio</td>
 <td className="px-4 py-3"><span className="rounded-full bg-pink-100 px-2 py-0.5 text-xs text-pink-700 ">Audio</span></td>
 <td className="px-4 py-3 text-slate-600 ">$</td>
 </tr>
 <tr className="hover:bg-slate-50 ">
 <td className="px-4 py-3 font-medium text-slate-900 ">Canva AI</td>
 <td className="px-4 py-3 text-slate-600 ">Store assets, ad creatives</td>
 <td className="px-4 py-3"><span className="rounded-full bg-rose-100 px-2 py-0.5 text-xs text-rose-700 ">Marketing</span></td>
 <td className="px-4 py-3 text-slate-600 ">$</td>
 </tr>
 <tr className="hover:bg-slate-50 ">
 <td className="px-4 py-3 font-medium text-slate-900 ">DeepL</td>
 <td className="px-4 py-3 text-slate-600 ">Text localization, translation</td>
 <td className="px-4 py-3"><span className="rounded-full bg-cyan-100 px-2 py-0.5 text-xs text-cyan-700 ">Localization</span></td>
 <td className="px-4 py-3 text-slate-600 ">$</td>
 </tr>
 <tr className="hover:bg-slate-50 ">
 ...
 <h3 className="mb-2 text-lg font-semibold text-slate-900 ">Solo Indie</h3>
 ...
 <h3 className="mb-2 text-lg font-semibold text-slate-900 ">Small Studio</h3>
 ...
 <h3 className="mb-2 text-lg font-semibold text-slate-900 ">Mid-Size Studio</h3>
