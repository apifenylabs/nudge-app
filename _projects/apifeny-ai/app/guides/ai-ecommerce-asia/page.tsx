...
export default function AIEcommerceAsiaGuide() {
 ...
 return (
 <section key={s.id} id={s.id} className={`scroll-mt-20 ${s.color} border-y border-gray-200/50 `}>
 ...
 <table className="min-w-full divide-y divide-gray-200 rounded-xl overflow-hidden border border-gray-200 ">
 <thead className="bg-gray-100 ">
 <tr>
 <th scope="col" className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Category</th>
 <th scope="col" className="px-4 py-3 text-left text-xs font-semibold text-green-700 uppercase tracking-wider">Free / Budget</th>
 <th scope="col" className="px-4 py-3 text-left text-xs font-semibold text-amber-700 uppercase tracking-wider">Mid-Range</th>
 <th scope="col" className="px-4 py-3 text-left text-xs font-semibold text-rose-700 uppercase tracking-wider">Premium</th>
 <th scope="col" className="px-4 py-3 text-left text-xs font-semibold text-blue-700 uppercase tracking-wider">ROI Notes</th>
 </tr>
 </thead>
 ...
 <span className="inline-block bg-green-50 text-green-700 text-[10px] font-medium px-2 py-0.5 rounded-full mb-1">Free / Budget</span>
 <br />
 {row.freeOption}
 </td>
 <td className="px-4 py-3 text-sm text-gray-600 ">
 <span className="inline-block bg-amber-50 text-amber-700 text-[10px] font-medium px-2 py-0.5 rounded-full mb-1">Mid</span>
 <br />
 {row.budgetOption}
 </td>
 <td className="px-4 py-3 text-sm text-gray-600 ">
 <span className="inline-block bg-rose-50 text-rose-700 text-[10px] font-medium px-2 py-0.5 rounded-full mb-1">Premium</span>
 <br />
 {row.premiumOption}
 </td>
 <td className="px-4 py-3 text-sm text-gray-600 ">
 <span className="inline-block bg-blue-50 text-blue-700 text-[10px] font-medium px-2 py-0.5 rounded-full mb-1">ROI</span>
 <br />
 {row.roiNotes}
 </td>
 </tr>
 ...
 <section id="getting-started" className="scroll-mt-20 bg-sky-50 border-y border-gray-200/50 ">
 <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
 <div className="flex items-center gap-3 mb-6">
 <div className="p-2.5 rounded-xl bg-white shadow-sm">
 ...
 <div>
 <h3 className="font-semibold text-gray-900 mb-1">Day 1: Set Up AI Product Photography</h3>
 ...
 <em className="block mt-1 text-gray-500 ">Time: 30 min | Cost: Free</em>
 </p>
 </div>
 </div>
 </div>
 ...
 <div>
 <h3 className="font-semibold text-gray-900 mb-1">Day 2: Optimize Product Listings with AI</h3>
 <p className="text-sm text-gray-600 ">
 ...
 <em className="block mt-1 text-gray-500 ">Time: 1 hour | Cost: Free-$20/mo</em>
 </p>
 </div>
 </div>
 </div>
 ...
 <div>
 <h3 className="font-semibold text-gray-900 mb-1">Day 3: Set Up Customer Service AI</h3>
 <p className="text-sm text-gray-600 ">
 ...
 <em className="block mt-1 text-gray-500 ">Time: 2 hours | Cost: $20-39/mo</em>
 </p>
 </div>
 </div>
 </div>
 ...
 <div>
 <h3 className="font-semibold text-gray-900 mb-1">Day 4: Launch AI-Powered Ad Campaign</h3>
 <p className="text-sm text-gray-600 ">
 ...
 <em className="block mt-1 text-gray-500 ">Time: 1.5 hours | Cost: Ad spend + $13-20/mo</em>
 </p>
 </div>
 </div>
 </div>
 ...
 <div>
 <h3 className="font-semibold text-gray-900 mb-1">Day 5: Analyze Inventory & Demand</h3>
 <p className="text-sm text-gray-600 ">
 ...
 <em className="block mt-1 text-gray-500 ">Time: 1 hour | Cost: Free</em>
 </p>
 </div>
 </div>
 </div>
 ...
 <div>
 <h3 className="font-semibold text-gray-900 mb-1">Day 6: Automate Review Management</h3>
 <p className="text-sm text-gray-600 ">
 ...
 <em className="block mt-1 text-gray-500 ">Time: 1 hour | Cost: $0-20/mo</em>
 </p>
 </div>
 </div>
 </div>
 ...
 <div>
 <h3 className="font-semibold text-gray-900 mb-1">Day 7: Review, Measure & Scale</h3>
 <p className="text-sm text-gray-600 ">
 ...
 <em className="block mt-1 text-gray-500 ">Time: 30 min | ROI review</em>
 </p>
 </div>
 </div>
 </div>
