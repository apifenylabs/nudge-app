    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-white via-red-50/30 to-white dark:from-gray-950 dark:via-red-950/10 dark:to-gray-950">
        ...
        <section className="relative overflow-hidden border-b border-red-100/50 dark:border-red-900/20">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(206,17,38,0.06),transparent_50%)] dark:bg-[radial-gradient(ellipse_at_top_right,rgba(206,17,38,0.08),transparent_50%)] pointer-events-none" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(255,255,255,0.04),transparent_50%)] dark:bg-[radial-gradient(ellipse_at_bottom_left,rgba(255,255,255,0.06),transparent_50%)] pointer-events-none" />
          <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 relative">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-red-200 bg-red-50 px-4 py-1.5 text-sm font-medium text-red-700 dark:border-red-800 dark:bg-red-950/50 dark:text-red-300">
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                <a
                  href="#top-picks"
                  className="inline-flex items-center gap-2 rounded-xl bg-[#CE1126] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-red-200/50 transition-all hover:bg-[#a80e1f] hover:shadow-red-300/50 dark:shadow-red-900/30"
                >
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {INDONESIA_AI_SNAPSHOT.map((stat) => (
                ...
                >
                  <p className="text-3xl font-bold text-[#CE1126] dark:text-red-400">{stat.value}</p>
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {WHY_INDONESIA.map((item) => (
                ...
                >
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-[#CE1126]/10 text-[#CE1126] dark:bg-red-900/30 dark:text-red-400">
              ...
              {ALL_CATEGORIES.map((cat) => (
                <div key={cat.id} id={cat.id}>
                  <div className="mb-6 flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#CE1126]/10 text-[#CE1126] dark:bg-red-900/30 dark:text-red-400">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {cat.tools.map((tool) => (
                      <div
                        key={tool.name}
                        className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-[#CE1126]/20 hover:shadow-md dark:border-gray-800 dark:bg-gray-900/50"
                      >
                        <span className="inline-block rounded-full bg-[#CE1126]/10 px-2.5 py-0.5 text-xs font-medium text-[#CE1126] dark:bg-red-900/40 dark:text-red-300">
                          {tool.tag}
                        </span>
              ...
              {top12.map((tool, i) => (
                <Link
                  ...
                  className={cn(
                    ...
                    'dark:border-gray-800 dark:bg-gray-900/50 dark:hover:border-red-700/40'
                  )}
                >
                  <div
                    className={cn(
                      ...
                      i === 0
                        ...
                        : 'bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400 border border-gray-300 dark:border-gray-700'
                    )}
                  >
                    #{i + 1}
                  </div>
                  ...
                  <div className="flex items-start gap-3 mb-3">
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#CE1126]/10 to-red-100 flex items-center justify-center shrink-0 border border-red-100 dark:border-red-900/30 dark:from-red-900/30 dark:to-red-950/30">
                      <span className="text-[#CE1126] font-bold text-sm dark:text-red-400">
                        {tool.name.split(' ').map(function(w) { return w[0]; }).join('').slice(0, 2).toUpperCase()}
                      </span>
                    </div>
                    <div className="min-w-0 flex-1">
                      <h3 className="text-base font-semibold text-gray-900 truncate group-hover:text-[#CE1126] transition-colors dark:text-white dark:group-hover:text-red-400">
                        {tool.name}
                      </h3>
                      <p className="text-xs text-gray-500 line-clamp-2 mt-0.5 leading-relaxed dark:text-gray-400">
                        {tool.tagline}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center gap-2 mb-3">
                    <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium bg-gray-100 text-gray-600 border border-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-700">
                      {tool.category}
                    </span>
                    <span
                      className={cn(
                        ...
                        tool.pricing_tier === 'Free'
                          ...
                          ? 'bg-sky-100 text-sky-700 border-sky-200 dark:bg-sky-900/30 dark:text-sky-400 dark:border-sky-800/30'
        ...
        <section className="border-y border-gray-100 bg-gray-50/50 dark:border-gray-800 dark:bg-gray-950/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            <div className="text-center mb-10 sm:mb-12">
              ...
              <p className="text-sm text-gray-500 max-w-xl mx-auto dark:text-gray-400">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 max-w-5xl mx-auto">
              {[
                ...
                return (
                  <div
                    key={item.title}
                    className="relative rounded-xl bg-white border border-gray-200 p-6 shadow-sm hover:shadow-md hover:border-[#CE1126]/20 transition-all dark:bg-gray-900/80 dark:border-gray-800"
                  >
                    <div className="relative">
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{item.title}</h3>
                      <p className="text-sm text-gray-500 leading-relaxed dark:text-gray-400">{item.description}</p>
                    </div>
                  </div>
                );
              })}
        ...
        {categorySections.map(function(section) {
          ...
          return (
            <section
              key={section.name}
              className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 border-b border-gray-100 dark:border-gray-800 last:border-b-0"
            >
                ...
                {section.tools.slice(0, 6).map(function(tool) {
                  return (
                    <Link
                      key={tool.id}
                      href={'/tools/' + tool.slug}
                      className="group relative block rounded-xl border border-gray-200 bg-white p-4 transition-all duration-300 hover:border-[#CE1126]/20 hover:shadow-md hover:-translate-y-0.5 dark:border-gray-800 dark:bg-gray-900/50 dark:hover:border-red-700/40"
                    >
                      <div className="flex items-start gap-2.5 mb-2">
                        <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#CE1126]/10 to-red-100 flex items-center justify-center shrink-0 border border-red-100 dark:border-red-900/30 dark:from-red-900/30 dark:to-red-950/30">
                          <span className="text-[#CE1126] font-bold text-xs dark:text-red-400">
                            {tool.name.split(' ').map(function(w) { return w[0]; }).join('').slice(0, 2).toUpperCase()}
                          </span>
                        </div>
                        <div className="min-w-0 flex-1">
                          <h3 className="text-sm font-semibold text-gray-900 truncate group-hover:text-[#CE1126] transition dark:text-white dark:group-hover:text-red-400">
                            {tool.name}
                          </h3>
                          <p className="text-[11px] text-gray-500 line-clamp-2 mt-0.5 dark:text-gray-400">
                            {tool.tagline}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-[10px] text-gray-500 dark:text-gray-400">{tool.avg_rating.toFixed(1)}</span>
                        </div>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                <Link
                  href={'/categories/' + sectionSlug}
                  className="inline-flex items-center gap-1 text-xs text-gray-400 hover:text-[#CE1126] transition dark:text-gray-500"
                >
        ...
        <section className="border-y border-gray-100 bg-gray-50/50 dark:border-gray-800 dark:bg-gray-950/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            ...
            <div className="mt-8 text-center">
              <Link
                href="/playbooks"
                className="group inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-gray-300 text-gray-700 hover:border-[#CE1126]/30 hover:text-[#CE1126] text-sm font-medium transition-all dark:border-gray-700 dark:text-gray-300"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto">
              {[
                ...
                return (
                  <div
                    key={item.title}
                    className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md hover:border-[#CE1126]/20 transition dark:bg-gray-900/50 dark:border-gray-800"
                  >
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{item.title}</h3>
                    <p className="text-sm text-gray-500 leading-relaxed dark:text-gray-400">{item.description}</p>
                  </div>
        ...
        <section className="border-t border-gray-100 bg-white dark:border-gray-800 dark:bg-gray-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
            <div className="text-center">
              <p className="text-[10px] text-gray-400 leading-loose max-w-3xl mx-auto dark:text-gray-500">
                <strong className="text-gray-500 dark:text-gray-400">Indonesia AI tools:</strong>{' '}
