...
import BuildGameInfographic from '@/components/playbook-infographics/BuildGameInfographic';
...
export default async function BuildAGameWithAiPage({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params;
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-8 sm:mb-10 mt-10">
          <EmailCapture
            templateContent={`You are a game design expert and AI prompt specialist. I want to build a game using AI.

My game idea: [describe your game idea]
Target platform: [mobile, web, desktop]
My experience level: [beginner, intermediate, advanced]

Give me:
1. A one-paragraph game concept
2. The core mechanics (3-5 bullet points)
3. The tech stack I should use (AI tools + frameworks)
4. A 5-step implementation plan
5. The first prompt I should run in Cursor/Claude

Be specific and actionable — I should be able to start building today.`}
            templateTitle="Free Prompt: Turn Your Game Idea Into a Build Plan"
            playbookSlug="build-a-game-with-ai"
            playbookTitle="Build a Game with AI"
