  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <div className="relative max-w-md w-full bg-tech-800 border border-tech-500/30 rounded-2xl p-6 sm:p-8 shadow-2xl shadow-neon/10">
        <SeoMetadata title="AI Workflow Automation — Build Your Autopilot System" description="Step-by-step guide to automating business workflows with AI agents. Covers Zapier alternatives, custom GPTs, RAG pipelines, and no-code automation." />
        <button
          onClick={onBack}
