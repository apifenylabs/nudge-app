    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <div className="relative max-w-md w-full bg-tech-800 border border-tech-500/30 rounded-2xl p-6 sm:p-8 shadow-2xl shadow-neon/10">
        ...
        <div className="text-center mb-6">
          ...
          <h3 className="text-xl font-bold text-white mb-1">AI for Data Analysis</h3>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <nav aria-label="Breadcrumb" className="mb-4">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs text-tech-300">
            ...
            <li className="text-tech-100 truncate max-w-[200px]">AI for Data Analysis</li>
          </ol>
        </nav>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-500/25 via-violet-500/15 to-tech-800 border border-indigo-500/20 mb-8 sm:mb-10">
          ...
          <div className="relative p-6 sm:p-8 lg:p-10">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-3">AI for Data Analysis: Spreadsheets to Insights</h1>
            ...
            <div className="flex flex-wrap gap-3 mb-4">
              ...
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-tech-600 text-tech-100 border border-tech-500/30"><Clock className="w-3 h-3" /> 7 chapters</span>
...
5. A 1-paragraph executive summary template`}
        ...
        {[["What's Inside", BookOpen, 'text-neon-light'],
          ...
          <section key={''+title} className="mb-8 sm:mb-10" id={title === "What's Inside" ? 'preview' : undefined}>
            <h2 className="text-lg sm:text-xl font-bold text-white mb-4 flex items-center gap-2"><Icon className={'w-4 h-4 ' + color} /> {''+title}</h2>
        ...
        <section className="mb-8 sm:mb-10">
          ...
          <div className="space-y-4">
            {sections.map((section) => (
              <details key={section.id} className="group rounded-xl border border-tech-500/20 bg-tech-700/50 overflow-hidden transition hover:border-indigo-500/20">
                <summary className="flex items-center justify-between p-4 sm:p-5 cursor-pointer list-none">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0"><h3 className="text-sm sm:text-base font-semibold text-white group-hover:text-indigo-300 transition">{section.title}</h3><p className="text-xs text-tech-300 mt-0.5 line-clamp-1">{section.description}</p></div>
                  </div>
        ...
        <section className="mb-8 sm:mb-10">
          <h2 className="text-lg sm:text-xl font-bold text-white mb-4 flex items-center gap-2"><Users className="w-4 h-4 text-indigo-400" /> Real Results</h2>
        ...
        <section className="mb-8 sm:mb-10">
          <h2 className="text-lg sm:text-xl font-bold text-white mb-4 flex items-center gap-2"><Zap className="w-4 h-4 text-amber-400" /> Free Bonuses ($46 Value)</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {bonuses.map((b, i) => (
          ...
          <div className="relative overflow-hidden rounded-2xl border border-tech-500/20 bg-tech-700/60 p-6 sm:p-8 text-center">
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 mb-4">
                ...
                <div className="text-center"><div className="text-2xl sm:text-3xl font-bold text-tech-300 line-through">$19</div><div className="text-xs text-tech-300">Next tier</div></div>
              </div>
        ...
        <section className="mb-8 sm:mb-10">
          ...
          <div className="space-y-3">
            {faqItems.map((faq, i) => (
              <details key={i} className="group rounded-xl border border-tech-500/20 bg-tech-700/50 overflow-hidden transition hover:border-indigo-500/20">
                <summary className="flex items-center justify-between p-4 sm:p-5 cursor-pointer list-none">
                  <span className="text-sm sm:text-base font-medium text-white group-hover:text-indigo-300 transition pr-4">{faq.q}</span>
                  <ChevronRight className="w-5 h-5 text-tech-300 shrink-0 transition-transform group-open:rotate-90" />
                </summary>
                <div className="px-4 sm:px-5 pb-4 sm:pb-5 border-t border-tech-500/10 pt-3">
        ...
        <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-500/20 via-green-500/10 to-tech-800 border border-emerald-500/20 p-6 sm:p-8 text-center">
          <div className="relative">
            ...
            <p className="text-sm text-tech-200 max-w-lg mx-auto mb-4">If this playbook doesn't save you 10x your investment within 30 days, I'll refund every cent. No questions asked.</p>
