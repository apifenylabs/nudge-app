...
function CheckoutOverlay({ onBack }: { onBack: () => void }) {
 ...
 <div className="relative max-w-md w-full bg-tech-800 border border-tech-500/30 rounded-2xl p-6 sm:p-8 shadow-2xl shadow-emerald-500/10">
 ...
 className="w-full bg-tech-900 border border-tech-500/50 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-tech-300 focus:outline-none focus:border-emerald-400/60 focus:ring-1 focus:ring-emerald-400/20 transition" />
 </div>
 ...
 <p className="text-[10px] text-tech-300 text-center">Secure checkout. Instant download after purchase.</p>
 </form>
 </div>
 </div>
 );
...
function DirectoryBuilderTemplateInner() {
 ...
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-tech-600 text-tech-100 border border-tech-500/30"><BookOpen className="w-3 h-3" /> 8 chapters</span>
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-tech-600 text-tech-100 border border-tech-500/30"><Sparkles className="w-3 h-3" /> AI agent prompts</span>
 ...
 <a href="#preview" className="inline-flex items-center gap-1.5 px-5 py-3 rounded-xl bg-tech-700 border border-tech-500/30 text-tech-100 text-sm font-medium hover:text-white hover:border-emerald-400/30 transition">
...
Score out of 10 and give me a green/yellow/red light.`}
 ...
 <div className="text-[10px] text-tech-300">{stat.label}</div>
 </div>
 ))}
 </div>
 </section>
 ...
 return (
 <div key={i} className="flex items-start gap-3 p-4 rounded-xl border border-tech-500/20 bg-tech-700/60 hover:border-emerald-400/20 transition">
 ...
 <details key={section.id} className="group rounded-xl border border-tech-500/20 bg-tech-700/50 overflow-hidden transition hover:border-emerald-400/20">
 ...
 <div className="space-y-3">
 {faqItems.map((faq, i) => (
 <details key={i} className="group rounded-xl border border-tech-500/20 bg-tech-700/50 overflow-hidden transition hover:border-emerald-400/20">
 <summary className="flex items-center justify-between p-4 sm:p-5 cursor-pointer list-none">
 ...
 <div className="flex flex-wrap justify-center gap-4 text-xs text-tech-300">
