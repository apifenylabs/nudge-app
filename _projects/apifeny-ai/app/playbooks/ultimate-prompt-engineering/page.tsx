...
import { ArrowLeft, Clock, BookOpen, Lightbulb, AlertTriangle, Sparkles, CheckCircle, Target, Zap, Star, BarChart3, DollarSign } from 'lucide-react';
...
import PromptEngineeringInfographic from '@/components/playbook-infographics/PromptEngineeringInfographic';
...
function buildPlaybookFAQs(pb: Playbook): FAQ[] {
  ...
  if (pb.related_tool_slugs.length > 0) {
    ...
    faqs.push({
      ...
      answer: `This playbook covers ${toolsList}. Step-by-step instructions guide you through using each tool effectively for this workflow.`,
    });
  }
...
export default async function UltimatePromptEngineeringPage({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params;
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-8 sm:mb-10 mt-10">
          <EmailCapture
            templateContent={`You are a prompt engineering master. I need a framework for writing better prompts.

My goal: [describe what you want to achieve with AI]
My tool: [ChatGPT, Claude, Gemini, or other]
My experience with prompting: [beginner, intermediate, advanced]

Give me:
1. The 5 components of every great prompt (with examples)
2. 3 prompt frameworks I can use immediately
3. Before/after examples of weak vs. strong prompts in my use case
4. A reusable prompt template I can save and adapt
5. Common mistakes to avoid in my specific use case

Be concrete — give me prompts I can copy-paste today.`}
            templateTitle="Free Prompt: Build Your Prompt Engineering Framework"
            playbookSlug="ultimate-prompt-engineering"
            playbookTitle="Ultimate Prompt Engineering"
