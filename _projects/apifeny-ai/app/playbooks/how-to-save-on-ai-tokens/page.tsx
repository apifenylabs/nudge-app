...
import SaveOnTokensInfographic from '@/components/playbook-infographics/SaveOnTokensInfographic';
...
export default async function HowToSaveOnAiTokensPage({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params;
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-8 sm:mb-10 mt-10">
          <EmailCapture
            templateContent={`You are an AI cost optimization expert. I need to reduce my AI tool spending without sacrificing output.

My current AI tools and monthly spend:
- [Tool 1]: $[X]/mo
- [Tool 2]: $[X]/mo
- [Tool 3]: $[X]/mo
...
Give me:
1. A cost audit of my current setup (what I'm overpaying for)
2. 3 specific strategies to cut costs by 30-50%
3. Tool alternatives that cost less (or are free)
4. Token optimization techniques I can apply today
5. A monthly budget plan with targets`}
            templateTitle="Free Prompt: AI Cost Audit & Optimization Plan"
            playbookSlug="how-to-save-on-ai-tokens"
            playbookTitle="How to Save on AI Tokens"
