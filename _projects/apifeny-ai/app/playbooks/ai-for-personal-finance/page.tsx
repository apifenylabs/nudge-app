...
function CheckoutOverlay({ onBack }) {
 ...
 <h3 className="text-xl font-bold text-gray-900 mb-1">AI for Personal Finance</h3>
...
function AIForPersonalFinanceInner() {
 ...
 <li className="text-gray-800 truncate max-w-[200px]">AI for Personal Finance</li>
 </ol>
 </nav>
 ...
 <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-3">AI for Personal Finance: Budget to Build Wealth</h1>
 <p className="text-sm sm:text-base text-gray-800 max-w-2xl mb-4 leading-relaxed">Take control of your money with AI. From budgeting and expense tracking to investment research and tax optimization — this 35+ page PDF shows you how to use ChatGPT, Claude, and Gemini to manage and grow your personal finances.</p>
 <div className="flex flex-wrap gap-3 mb-4">
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-gray-100 text-gray-800"><FileText className="w-3 h-3" /> 30+ pages</span>
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-gray-100 text-gray-800"><Clock className="w-3 h-3" /> 5 chapters</span>
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-gray-100 text-gray-800"><Sparkles className="w-3 h-3" /> 20+ prompts</span>
...
5. Action items — top 3 priorities this month`}
 ...
 <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 flex items-center gap-2"><BookOpen className="w-4 h-4 text-neon-light" /> What's Inside</h2>
 ...
 {/* Who This Is For */}
 <section className="mb-8 sm:mb-10">
 <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 flex items-center gap-2"><Users className="w-4 h-4 text-green-400" /> Who This Is For</h2>
 ...
 {/* What You'll Learn */}
 <section className="mb-8 sm:mb-10">
 <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 flex items-center gap-2"><Target className="w-4 h-4 text-teal-400" /> What You'll Learn</h2>
 ...
 {sections.map((s) => (
 <details key={s.id} className="group rounded-xl border border-gray-200 bg-white overflow-hidden transition hover:border-emerald-500/20">
 ...
 <div><h3 className="text-sm sm:text-base font-semibold text-gray-900 group-hover:text-emerald-300">{s.title}</h3><p className="text-xs text-gray-600 mt-0.5 line-clamp-1">{s.desc}</p></div>
 </div>
 ...
 {/* Real Results */}
 <section className="mb-8 sm:mb-10">
 <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 flex items-center gap-2"><Users className="w-4 h-4 text-emerald-400" /> Real Results</h2>
 ...
 {/* Bonuses */}
 <section className="mb-8 sm:mb-10">
 <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 flex items-center gap-2"><Zap className="w-4 h-4 text-amber-400" /> Free Bonuses ($35 Value)</h2>
 <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
 {bonuses.map((bonus, i) => (
 ...
 {faqItems.map((faq, i) => (
 <details key={i} className="group rounded-xl border border-gray-200 bg-white overflow-hidden transition hover:border-emerald-500/20">
 <summary className="flex items-center justify-between p-4 sm:p-5 cursor-pointer list-none"><span className="text-sm sm:text-base font-medium text-gray-900 group-hover:text-emerald-300 pr-4">{faq.q}</span><ChevronRight className="w-5 h-5 text-gray-600 shrink-0 transition-transform group-open:rotate-90" /></summary>
 ...
 <p className="text-sm text-gray-700 max-w-lg mx-auto mb-4 leading-relaxed">If AI for Personal Finance doesn't help you save money within 30 days, I'll refund every cent. No questions asked. You keep the bonuses.</p>
 ...
 <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Ready to Get Started?</h2>
 ...
 <div className="text-left"><div className="text-2xl font-bold text-gray-900">$7</div><div className="text-[10px] text-gray-600">one-time payment</div></div>
