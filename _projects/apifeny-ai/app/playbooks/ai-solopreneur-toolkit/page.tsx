...
const socialProofStats = [
  ...
  { icon: TrendingUp, value: '$0 → $9k', label: 'MRR built solo', color: 'text-emerald-400', bg: 'bg-emerald-500/10', border: 'border-emerald-500/20' },
...
const faqItems = [
  {
    ...
    a: "Yes! The AI Solopreneur Toolkit is a digital PDF delivered instantly after purchase. You'll also receive a download link via email so you can access it anytime, anywhere.",
  },
  {
  ...
  },
  {
    ...
    a: "Absolutely. If the AI Solopreneur Toolkit doesn't help you save 10x your investment within 30 days, I'll refund every cent. No questions asked. Just email support and I'll process it immediately.",
  },
  {
  ...
  return (
    <>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <SeoMetadata title="AI Solopreneur Toolkit — Build a $10K/Mo Business" description="Step-by-step playbook for building a profitable solopreneur business using AI tools. Covers mindset, tool stack, MVP creation, content engine, monetization." />
        {/* Breadcrumb */}
        <nav aria-label="Breadcrumb" className="mb-4">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs text-tech-300">
            ...
            <li className="text-tech-100 truncate max-w-[200px]">AI Solopreneur Toolkit</li>
          </ol>
        </nav>
        ...
        {/* HERO SECTION                                     */}
        {/* ═══════════════════════════════════════════════════ */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-neon/25 via-aqua/15 to-tech-800 border border-neon/20 mb-8 sm:mb-10">
        ...
        <section className="mb-8 sm:mb-10">
          ...
          <p className="text-sm text-tech-200 mb-6">
            Here&apos;s everything covered in the AI Solopreneur Toolkit. Each chapter is
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 mb-4">
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl font-bold text-neon-light">$9</div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-500/20 via-green-500/10 to-tech-800 border border-emerald-500/20 p-6 sm:p-8 text-center">
            ...
            <div className="relative">
              ...
              <p className="text-sm text-tech-200 max-w-lg mx-auto mb-4 leading-relaxed">
                If the AI Solopreneur Toolkit doesn&apos;t help you save 10x times your investment
