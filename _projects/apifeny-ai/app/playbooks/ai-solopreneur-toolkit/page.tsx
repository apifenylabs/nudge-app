        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500/25 via-orange-500/15 to-tech-800 border border-amber-500/20 mb-8 sm:mb-10">
          ...
          <div className="relative p-6 sm:p-8 lg:p-10">
            ...
            <div className="flex flex-wrap gap-3 mb-4">
              ...
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-tech-600 text-tech-100 border border-tech-500/30"><PenTool className="w-3 h-3" /> 5 chapters</span>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-500/10 via-amber-500/10 to-tech-800 border border-amber-500/20 p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
              <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20">
                ...
                <div className="text-xs text-tech-200">Intercom Customer Support → <span className="text-emerald-400">$47/mo AI bot</span></div>
              </div>
              <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20">
                <div className="text-lg font-bold text-red-400">$150/mo</div>
                <div className="text-xs text-tech-200">Content Writers → <span className="text-emerald-400">$20/mo AI</span></div>
              </div>
              <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20">
                <div className="text-lg font-bold text-red-400">$200/mo</div>
                <div className="text-xs text-tech-200">Designers → <span className="text-emerald-400">$13/mo AI</span></div>
              </div>
              <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20">
                <div className="text-lg font-bold text-red-400">$500/mo</div>
                <div className="text-xs text-tech-200">SEO Agency → <span className="text-emerald-400">$0 AI (free tools)</span></div>
              </div>
              <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20">
                <div className="text-lg font-bold text-red-400">$350/mo</div>
                <div className="text-xs text-tech-200">Analysts → <span className="text-emerald-400">$10/mo AI</span></div>
              </div>
              <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 flex flex-col items-center justify-center">
                ...
                <div className="text-xs text-tech-200">Total savings</div>
                <div className="text-[10px] text-tech-300">$70/mo AI cost - $2,200/mo services</div>
              </div>
            </div>
          </div>
        </section>
