...
const sections: Section[] = [
  {
    ...
    title: 'Bulk Product Descriptions with ChatGPT',
    description: 'Upload your entire product catalog and generate SEO-optimized descriptions in minutes instead of weeks. Titles, meta descriptions, bullet points, and long descriptions — all from one CSV.',
    items: [
      'Upload CSV/JSON catalogs of 200+ products at once',
      'Generate SEO titles, meta descriptions, and bullet points',
      'Specify brand tone, word count, and target keywords',
      'Output structured data ready for Shopify/WooCommerce import',
      'Batch update entire product lines with consistent formatting',
    ],
  },
  {
    id: 'product-images',
    icon: <Image className="w-5 h-5 text-amber-400" />,
    title: 'Product Photography with Midjourney',
    description: 'Generate studio-quality product images, lifestyle shots, and seasonal variants without a photo studio. Create consistent brand imagery across your entire catalog.',
    items: [
      'Generate professional product photos with consistent backgrounds',
      'Create lifestyle shots showing products in use',
      'Produce seasonal variants (holiday, summer, back-to-school)',
      'Use image-to-image for uniform brand aesthetics',
      'Generate color variants without reshoots',
    ],
  },
  {
    id: 'store-visuals',
    icon: <Image className="w-5 h-5 text-rose-400" />,
    title: 'Store Design with Canva AI',
    description: 'Design professional store banners, product collages, social media ads, and promotional graphics from one unified brand kit. Canva AI suggests layouts based on your products.',
    items: [
      'Create consistent store banners and promotional graphics',
      'Design product collages and collection pages',
      'Generate social media ads optimized for each platform',
      'Build email and ad headers from your brand kit',
      'Resize one design for all channels automatically',
    ],
  },
  {
    id: 'ai-chatbot',
    ...
    description: 'Build a store assistant that handles orders, shipping, returns, and product recommendations 24/7. Train it on your catalog and policies with zero coding required.',
    items: [
      'Set up AI chatbot for order status and shipping queries',
      'Answer size guides, return policies, and FAQs automatically',
      'Provide personalized product recommendations',
      'Start with FAQ-only mode, expand to order lookups',
      'Handle 60-80% of customer queries without human intervention',
    ],
  },
  {
    id: 'inventory',
    icon: <Package className="w-5 h-5 text-cyan-400" />,
    title: 'Inventory Forecasting with Perplexity + Gemini',
    description: 'Predict demand, optimize stock levels, and identify slow-movers using AI-powered market trend analysis combined with your sales history.',
    items: [
      'Analyze market trends for demand forecasting',
      'Set optimal reorder points for every SKU',
      'Plan seasonal stock levels with AI predictions',
      'Identify slow-moving inventory before it becomes a problem',
      'Feed competitor pricing insights into your strategy',
    ],
  },
  {
    id: 'email-campaigns',
    icon: <Mail className="w-5 h-5 text-fuchsia-400" />,
    title: 'Email Campaigns with Jasper AI',
    description: 'Build automated email sequences: abandoned cart recovery, post-purchase follow-ups, back-in-stock alerts, and seasonal promotions — all personalized by customer segment.',
    items: [
      'Abandoned cart recovery sequences that convert',
      'Post-purchase follow-up and upsell campaigns',
      'Back-in-stock alerts for high-demand products',
      'Seasonal promotions and personalized offers',
      'A/B test subject lines and CTAs with AI-generated variants',
    ],
  },
];
...
const includedItems = [
  { icon: FileText, text: '6 comprehensive chapters', subtext: '30+ pages of actionable ecommerce AI strategies' },
  { icon: FileText, text: 'Ready-to-use prompt library', subtext: '40+ copy-paste prompts for product descriptions' },
  { icon: Image, text: 'Midjourney style references', subtext: 'Consistent branding across all product images' },
  { icon: MessageSquare, text: 'Chatbot setup templates', subtext: 'FAQ, order lookup, and recommendation flows' },
  { icon: DollarSign, text: 'Revenue strategy worksheets', subtext: 'Pricing, upselling, and conversion optimization' },
  { icon: Rocket, text: 'Automation pipeline blueprints', subtext: 'From CSV import to published listings in hours' },
];

const whoItsFor = [
  { icon: ShoppingBag, text: 'Shopify store owners', subtext: 'Scale your store without hiring a team' },
  { icon: Target, text: 'Ecommerce founders', subtext: 'Cut listing time by 95% with AI automation' },
  { icon: Star, text: 'Dropshippers & resellers', subtext: 'Generate consistent product listings at scale' },
  { icon: Lightbulb, text: 'Amazon FBA sellers', subtext: 'Optimize listings for higher conversion rates' },
];

const whatYoullLearn = [
  { icon: Brain, text: 'Generate listings in bulk', subtext: '200+ products in 2 days vs 4 weeks manually' },
  { icon: Image, text: 'Create pro product images', subtext: 'Studio-quality shots without a photo studio' },
  { icon: MessageSquare, text: 'Automate customer support', subtext: 'AI chatbot handles 70% of queries' },
  { icon: TrendingUp, text: 'Boost conversion rates', subtext: '+18% higher conversion with AI-optimized listings' },
];

// ─── Social Proof Stats ────────────────────────────────────

const socialProofStats = [
  { icon: ShoppingBag, value: '500+', label: 'Products listed per batch', color: 'text-orange-400', bg: 'bg-orange-500/10', border: 'border-orange-500/20' },
  { icon: TrendingUp, value: '+18%', label: 'Conversion rate improvement', color: 'text-emerald-400', bg: 'bg-emerald-500/10', border: 'border-emerald-500/20' },
  { icon: Clock, value: '95%', label: 'Faster listing creation', color: 'text-cyan-400', bg: 'bg-cyan-500/10', border: 'border-cyan-500/20' },
  { icon: Zap, value: '70%', label: 'Support tickets automated', color: 'text-amber-400', bg: 'bg-amber-500/10', border: 'border-amber-500/20' },
];
...
const testimonials = [
  {
    name: 'James Koh',
    title: 'Shopify Store Owner, Singapore',
    quote: 'I listed 500 products in 2 days using the bulk description pipeline. Before this playbook, it took my VA 4 weeks for the same work. The chatbot setup alone saved me $2K/mo in support staff.',
    stars: 5,
  },
  {
    name: 'Lisa Wong',
    title: 'Ecommerce Brand, Hong Kong',
    quote: 'The Midjourney product photography guide is worth 10x the price. We generated an entire seasonal catalog in one weekend — no studio, no photographer, no reshoot costs.',
    stars: 5,
  },
  {
    name: 'Raj Menon',
    title: 'Amazon FBA Seller, Malaysia',
    quote: 'Conversion jumped 18% after I optimized my listings with the SEO description prompts. I use the chatbot template for customer queries and it handles 7/10 questions automatically.',
    stars: 5,
  },
];
...
const bonuses = [
  { name: 'Product CSV-to-Shopify Pipeline Template', value: '$19', desc: 'Ready-to-use Google Sheets template with ChatGPT prompts for bulk product description generation' },
  { name: '50+ Copy-Paste Ecommerce Prompts', value: '$15', desc: 'Prompts for descriptions, images, emails, chatbot responses, and inventory analysis' },
  { name: 'Store Launch Checklist (AI-Powered)', value: '$13', desc: 'Step-by-step checklist with AI prompts for each stage of launching or revamping your store' },
];
...
const faqItems = [
  {
    ...
    a: "Yes! The AI for Ecommerce playbook is a digital PDF delivered instantly after purchase. You'll also receive a download link via email so you can access it anytime, anywhere.",
  },
  {
    q: 'Do I need technical skills?',
    a: "Not at all. This playbook is designed for ecommerce owners with no coding background. Every system includes step-by-step instructions, copy-paste prompts, and clear explanations. If you can upload a CSV, you can follow this playbook.",
  },
  {
    q: 'Which platforms does it support?',
    a: "The playbook works with Shopify, WooCommerce, BigCommerce, Amazon FBA, and any custom store. We provide platform-specific instructions for the most common setups.",
  },
  {
    q: 'Can I get a refund?',
    a: "Absolutely. If the AI for Ecommerce playbook doesn't help you save 10x your investment within 30 days, I'll refund every cent. No questions asked. Just email support and I'll process it immediately.",
  },
  {
  ...
  const handlePurchase = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/create-checkout', {
        ...
        body: JSON.stringify({ email, product: 'ai-for-ecommerce' }),
      });
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <div className="relative max-w-md w-full bg-tech-800 border border-tech-500/30 rounded-2xl p-6 sm:p-8 shadow-2xl shadow-orange-500/10">
        <SeoMetadata title="AI for E-Commerce — Boost Sales & Cut Costs" description="Practical AI playbook for e-commerce businesses. Product descriptions, customer service automation, dynamic pricing, inventory forecasting, and personalized recommendations." />
        <button
          onClick={onBack}
        ...
        <div className="text-center mb-6">
          ...
          <h3 className="text-xl font-bold text-white mb-1">AI for Ecommerce</h3>
        ...
        {status === 'success' ? (
          ...
          <form onSubmit={handlePurchase} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 text-white font-semibold text-sm hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <nav aria-label="Breadcrumb" className="mb-4">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs text-tech-300">
            ...
            <li className="text-tech-100 truncate max-w-[200px]">AI for Ecommerce</li>
          </ol>
        </nav>
          ...
          <div className="relative p-6 sm:p-8 lg:p-10">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 text-white font-semibold text-sm hover:opacity-90 transition hover:-translate-y-0.5 shadow-lg shadow-orange-500/20"
              >
                <Download className="w-4 h-4" />
                Download PDF — $9
              </button>
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3 sm:gap-4 text-xs text-tech-200">
              <span className="flex items-center gap-1.5">
                ...
                100+ store owners have downloaded this playbook
              </span>
              <span className="flex items-center gap-1.5">
        ...
        <section className="mb-8 sm:mb-10">
          ...
          <p className="text-sm text-tech-200 mb-6">
            Here&apos;s everything covered in the AI for Ecommerce playbook. Each chapter is
        ...
        <section className="mb-8 sm:mb-10">
          ...
          <div className="mt-4 p-4 rounded-xl border border-emerald-500/20 bg-emerald-500/5 text-center">
            <p className="text-sm text-emerald-200">
              ...
              Every strategy in this playbook is battle-tested on real stores. Results are from actual ecommerce owners using these exact workflows.
            </p>
          </div>
        </section>
        ...
        {/* ═══════════════════════════════════════════════════ */}
        <section className="mb-8 sm:mb-10">
          <div className="relative overflow-hidden rounded-2xl border border-orange-500/20 bg-tech-700/60 p-6 sm:p-8 text-center">
            ...
            <div className="relative">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 mb-3">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-500/10 text-orange-400 border border-orange-500/20 text-xs">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-500/20 via-green-500/10 to-tech-800 border border-emerald-500/20 p-6 sm:p-8 text-center">
            ...
            <div className="relative">
              ...
              <p className="text-sm text-tech-200 max-w-lg mx-auto mb-4 leading-relaxed">
                If the AI for Ecommerce playbook doesn&apos;t help you save 10x times your investment
        ...
        {/* ═══════════════════════════════════════════════════ */}
        <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-500/20 via-amber-500/10 to-fuchsia-500/10 border border-orange-500/20 p-6 sm:p-8 text-center">
          <div className="absolute inset-0 bg-tech-grid opacity-20" />
          ...
          <div className="relative">
            ...
            <p className="text-sm text-tech-200 max-w-lg mx-auto mb-4">
              Get the complete AI for Ecommerce PDF playbook. Every strategy, prompt, and system
