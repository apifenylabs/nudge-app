...
function CheckoutOverlay({ onBack }: { onBack: () => void }) {
 ...
 <div className="relative max-w-md w-full bg-gray-50 border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-2xl shadow-pink-500/10">
 ...
 className="w-full bg-white border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-pink-400/60 focus:ring-1 focus:ring-pink-400/20 transition" />
 </div>
 ...
 <p className="text-[10px] text-gray-600 text-center">Secure checkout. Your PDF will be available immediately after purchase.</p>
 </form>
 )}
 </div>
 </div>
...
function AIContentCreationForBusyFoundersInner() {
 ...
 <li className="text-gray-800 truncate max-w-[200px]">AI Content Creation for Busy Founders</li>
 </ol>
 </nav>
 ...
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-gray-100 text-gray-800 border border-gray-200"><FileText className="w-3 h-3" /> 45+ pages</span>
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-gray-100 text-gray-800 border border-gray-200"><PenTool className="w-3 h-3" /> 7 chapters</span>
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-gray-100 text-gray-800 border border-gray-200"><Sparkles className="w-3 h-3" /> 40+ prompts</span>
 ...
 <a href="#preview" className="inline-flex items-center gap-1.5 px-5 py-3 rounded-xl bg-white border border-gray-200 text-gray-800 text-sm font-medium hover:text-white hover:border-pink-400/30 transition">
...
Format it as a calendar I can copy into my Notion or Google Sheets.`}
 ...
 return (
 <div key={i} className="flex items-start gap-3 p-4 rounded-xl border border-gray-200 bg-gray-50 hover:border-pink-400/20 transition">
 ...
 <details key={section.id} className="group rounded-xl border border-gray-200 bg-white overflow-hidden transition hover:border-pink-400/20">
 ...
 <span className="text-xs text-gray-600 line-through">{bonus.value}</span>
 </div>
 </div>
 ))}
 </div>
 <p className="mt-4 text-xs text-gray-600 text-center">Get all 3 bonuses instantly when you buy today.</p>
 </section>
 ...
 <div className="text-center">
 <div className="text-2xl sm:text-3xl font-bold text-gray-600 line-through">$19</div>
