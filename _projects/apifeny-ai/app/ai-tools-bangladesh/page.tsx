...
export default function AiToolsBangladeshPage() {
 ...
 {/* ── Hero ─────────────────────────────────────── */}
 <section className="relative overflow-hidden border-b border-green-100/50 ">
 <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(0,106,78,0.06),transparent_50%)] ,rgba(0,106,78,0.08),transparent_50%)] pointer-events-none" />
 ...
 <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-green-200 bg-green-50 px-4 py-1.5 text-sm font-medium text-[#006A4E] ">
 ...
 <a
 href="#top-picks"
 className="inline-flex items-center gap-2 rounded-xl bg-[#006A4E] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-green-200/50 transition-all hover:bg-[#00503A] hover:shadow-green-300/50 "
 >
 ...
 <div
 key={s.title}
 className="rounded-xl border border-green-100/60 bg-white/80 p-5 shadow-sm transition-all hover:shadow-md "
 >
 ...
 <div
 key={stat.label}
 className="rounded-xl border border-green-100/60 bg-white p-6 text-center shadow-sm "
 >
 <p className="text-3xl font-bold text-[#006A4E] ">{stat.value}</p>
 ...
 <div
 key={item.title}
 className="group relative rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-[#006A4E]/30 hover:shadow-md #006A4E]/40"
 >
 <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-[#006A4E]/10 text-[#006A4E] ">
 ...
 <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#006A4E]/10 text-[#006A4E] ">
 ...
 <div
 key={tool.name}
 className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-[#006A4E]/20 hover:shadow-md "
 >
 <span className="inline-block rounded-full bg-[#006A4E]/10 px-2.5 py-0.5 text-xs font-medium text-[#006A4E] ">
 {tool.tag}
 </span>
