    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-white via-blue-50/30 to-white dark:from-gray-950 dark:via-blue-950/10 dark:to-gray-950">
        ...
        <section className="relative overflow-hidden border-b border-blue-100/50 dark:border-blue-900/20">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(0,74,173,0.06),transparent_50%)] dark:bg-[radial-gradient(ellipse_at_top_right,rgba(0,74,173,0.08),transparent_50%)] pointer-events-none" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(255,0,0,0.04),transparent_50%)] dark:bg-[radial-gradient(ellipse_at_bottom_left,rgba(255,0,0,0.06),transparent_50%)] pointer-events-none" />
          <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 relative">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-1.5 text-sm font-medium text-[#003DA5] dark:border-blue-800 dark:bg-blue-950/50 dark:text-blue-300">
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                <a
                  href="#top-picks"
                  className="inline-flex items-center gap-2 rounded-xl bg-[#003DA5] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-200/50 transition-all hover:bg-[#002D7A] hover:shadow-blue-300/50 dark:shadow-blue-900/30"
                >
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {NP_AI_SNAPSHOT.map((stat) => (
                ...
                >
                  <p className="text-3xl font-bold text-[#003DA5] dark:text-blue-400">{stat.value}</p>
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {WHY_NP.map((item) => (
                <div
                  key={item.title}
                  className="group relative rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-[#003DA5]/30 hover:shadow-md dark:border-gray-800 dark:bg-gray-900/50 dark:hover:border-[#003DA5]/40"
                >
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-[#003DA5]/10 text-[#003DA5] dark:bg-blue-900/30 dark:text-blue-400">
              ...
              {ALL_CATEGORIES.map((cat) => (
                <div key={cat.id} id={cat.id}>
                  <div className="mb-6 flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#003DA5]/10 text-[#003DA5] dark:bg-blue-900/30 dark:text-blue-400">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {cat.tools.map((tool) => (
                      <div
                        key={tool.name}
                        className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-[#003DA5]/20 hover:shadow-md dark:border-gray-800 dark:bg-gray-900/50"
                      >
                        <span className="inline-block rounded-full bg-[#003DA5]/10 px-2.5 py-0.5 text-xs font-medium text-[#003DA5] dark:bg-blue-900/40 dark:text-blue-300">
                          {tool.tag}
                        </span>
