...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://apifeny.ai/ai-tools-taiwan',
    siteName: 'Apifeny AI',
    locale: 'zh_TW',
    type: 'website',
  },
  ...
  alternates: {
    canonical: 'https://apifeny.ai/ai-tools-taiwan',
    languages: {
      'zh-TW': 'https://apifeny.ai/ai-tools-taiwan',
      'en': 'https://apifeny.ai/ai-tools-taiwan',
    },
  },
};
