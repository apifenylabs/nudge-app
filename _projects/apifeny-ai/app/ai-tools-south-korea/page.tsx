...
export default function AiToolsSouthKoreaPage() {
 ...
 <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(60,90,210,0.06),transparent_50%)] ,rgba(60,90,210,0.08),transparent_50%)] pointer-events-none" />
 <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(204,0,0,0.04),transparent_50%)] ,rgba(204,0,0,0.06),transparent_50%)] pointer-events-none" />
 <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 relative">
 <div className="mx-auto max-w-3xl text-center">
 <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-1.5 text-sm font-medium text-[#3C5AD2] ">
 ...
 <a
 href="#top-picks"
 className="inline-flex items-center gap-2 rounded-xl bg-[#3C5AD2] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-200/50 transition-all hover:bg-[#2E47A8] hover:shadow-blue-300/50 "
 >
 ...
 >
 <p className="text-3xl font-bold text-[#3C5AD2] ">{stat.value}</p>
 ...
 <div
 key={item.title}
 className="group relative rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-[#3C5AD2]/30 hover:shadow-md #3C5AD2]/40"
 >
 <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-[#3C5AD2]/10 text-[#3C5AD2] ">
 ...
 <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#3C5AD2]/10 text-[#3C5AD2] ">
 ...
 <div
 key={tool.name}
 className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-[#3C5AD2]/20 hover:shadow-md "
 >
 <span className="inline-block rounded-full bg-[#3C5AD2]/10 px-2.5 py-0.5 text-xs font-medium text-[#3C5AD2] ">
 {tool.tag}
 </span>
