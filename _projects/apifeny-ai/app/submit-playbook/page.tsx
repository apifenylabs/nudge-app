...
export default function SubmitPlaybookPage() {
 ...
 <p className="text-sm text-tech-200 max-w-md mx-auto mb-6">
 ...
 <div>
 <label className="block text-xs font-medium text-tech-200 mb-1.5">
 ...
 className="w-full bg-tech-800 border border-tech-500/50 rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-tech-300 focus:outline-none focus:border-emerald-500/50 transition"
 />
 </div>
 <div>
 <label className="block text-xs font-medium text-tech-200 mb-1.5">Subtitle</label>
 <input
 type="text"
 value={form.subtitle}
 ...
 rows={3}
 className="w-full bg-tech-800 border border-tech-500/50 rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-tech-300 focus:outline-none focus:border-emerald-500/50 transition resize-none"
 />
 </div>
 </div>
 </section>
 ...
 <div>
 <label className="block text-xs font-medium text-tech-200 mb-1.5">Difficulty</label>
 <select
 value={form.difficulty}
 onChange={(e) => update('difficulty', e.target.value as FormData['difficulty'])}
 className="w-full bg-tech-800 border border-tech-500/50 rounded-lg px-3 py-2.5 text-sm text-white focus:outline-none focus:border-emerald-500/50 transition"
 >
 ...
 <div>
 <label className="block text-xs font-medium text-tech-200 mb-1.5">Pipeline Stage</label>
 <select
 ...
 <div>
 <label className="block text-xs font-medium text-tech-200 mb-1.5">Icon</label>
 ...
 : 'bg-tech-800 border-tech-500/30 hover:border-tech-400/50'
 )}
 >
 {icon}
 </button>
 ...
 <p className="text-xs text-tech-300 mb-3">Select the tools this playbook covers.</p>
 ...
 className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-tech-600 hover:bg-tech-500 text-xs text-white transition"
 >
 ...
 <div key={i} className="p-4 rounded-lg bg-tech-800 border border-tech-500/20">
 ...
 <span className="text-xs text-tech-300">Step {i + 1}</span>
 {form.steps.length > 1 && (
 <button
 type="button"
 onClick={() => update('steps', form.steps.filter((_, j) => j !== i))}
 className="ml-auto text-tech-300 hover:text-rose-400 transition"
 >
 ...
 className="w-full bg-tech-900 border border-tech-500/50 rounded-lg px-3 py-2 text-sm text-white placeholder:text-tech-300 focus:outline-none focus:border-emerald-500/50 transition"
 />
 <textarea
 ...
 rows={2}
 className="w-full bg-tech-900 border border-tech-500/50 rounded-lg px-3 py-2 text-sm text-white placeholder:text-tech-300 focus:outline-none focus:border-emerald-500/50 transition resize-none"
 />
 <input
 type="text"
 value={step.tip}
 ...
 className="w-full bg-tech-900 border border-asia/30 rounded-lg px-3 py-2 text-sm text-white placeholder:text-tech-300 focus:outline-none focus:border-asia/50 transition"
 />
 </div>
 </div>
 ))}
 ...
 className="flex-1 bg-tech-800 border border-tech-500/50 rounded-lg px-3 py-2 text-sm text-white placeholder:text-tech-300 focus:outline-none focus:border-emerald-500/50 transition"
 />
 {form.pro_tips.length > 1 && (
 <button
 type="button"
 onClick={() => update('pro_tips', form.pro_tips.filter((_, j) => j !== i))}
 className="text-tech-300 hover:text-rose-400 transition"
 >
 <X className="w-3.5 h-3.5" />
 </button>
 )}
 ...
 <section className="rounded-xl border border-dashed border-emerald-500/20 bg-tech-700/30 p-6">
 <h2 className="text-base font-semibold text-white mb-3 flex items-center gap-2">
 <TrendingUp className="w-4 h-4 text-emerald-400" />
 Real Results (optional but encouraged)
 </h2>
 <p className="text-xs text-tech-300 mb-4">
 Add measurable outcomes. This helps the community see the real impact of your workflow.
 </p>
 <div className="space-y-3">
 {form.real_results.map((result, i) => (
 <div key={i} className="flex flex-col sm:flex-row gap-2 p-3 rounded-lg bg-tech-800 border border-tech-500/20">
 <input
 type="text"
 value={result.metric}
 onChange={(e) => {
 ...
 className="flex-1 bg-tech-900 border border-tech-500/50 rounded-lg px-3 py-2 text-xs text-white placeholder:text-tech-300 focus:outline-none focus:border-emerald-500/50 transition"
 />
 <input
 type="text"
 value={result.value}
 ...
 className="w-full sm:w-28 bg-tech-900 border border-tech-500/50 rounded-lg px-3 py-2 text-xs text-white placeholder:text-tech-300 focus:outline-none focus:border-emerald-500/50 transition"
 />
 ...
 {/* Sample prompts */}
 <div className="mt-6 pt-4 border-t border-tech-500/20">
 <h3 className="text-sm font-semibold text-white mb-3 flex items-center gap-2">
 <MessageSquare className="w-4 h-4 text-sky-400" />
 Sample Prompts (optional)
 </h3>
 {form.sample_prompts.map((sp, i) => (
 <div key={i} className="p-3 rounded-lg bg-tech-800 border border-tech-500/20 mb-3">
 <div className="flex items-center justify-between mb-2">
 <span className="text-[10px] text-tech-400">Prompt #{i + 1}</span>
 <button
 type="button"
 onClick={() =>
 ...
 rows={2}
 className="w-full bg-tech-900 border border-tech-500/50 rounded-lg px-3 py-2 text-xs text-white placeholder:text-tech-300 focus:outline-none focus:border-emerald-500/50 transition resize-none font-mono"
 />
 <input
 type="text"
 ...
 className="w-full bg-tech-900 border border-tech-500/50 rounded-lg px-3 py-2 text-xs text-white placeholder:text-tech-300 focus:outline-none focus:border-emerald-500/50 transition"
 />
 <input
 type="text"
 ...
 className="w-full bg-tech-900 border border-emerald-500/20 rounded-lg px-3 py-2 text-xs text-white placeholder:text-tech-300 focus:outline-none focus:border-emerald-500/50 transition"
 />
 <input
 type="text"
 value={sp.what_didnt}
 ...
 className="w-full bg-tech-900 border border-amber-500/20 rounded-lg px-3 py-2 text-xs text-white placeholder:text-tech-300 focus:outline-none focus:border-amber-500/50 transition"
 />
 </div>
 </div>
 ))}
 ...
 {/* Submit */}
 <div className="flex flex-col sm:flex-row items-center gap-3 justify-end pt-4 border-t border-tech-500/20">
 <Link
 href="/community-playbook"
 className="px-5 py-2.5 rounded-lg border border-tech-500/30 text-sm text-tech-200 hover:text-white transition"
 >
 Cancel
 </Link>
 <button
