...
export default function CompareIndexPage() {
 ...
 <h2 className="text-xl font-bold text-gray-900 group-hover:text-neon-light transition">
 {cmp.title}
 </h2>
 </div>
 ...
 <h2 className="text-xl font-bold text-gray-900 mb-2">Want to compare two AI tools?</h2>
