...
export default function PerplexityVsChatGPTCompare() {
 ...
 <div>
 <h3 className="text-lg font-bold text-gray-900">Perplexity</h3>
 ...
 <strong className="text-gray-900">Tie</strong> on: pricing
 </p>
 </div>
 </section>
 ...
 <Search className="w-5 h-5 text-violet-300" />
 <h3 className="text-base font-bold text-gray-900">Choose Perplexity if you:</h3>
 </div>
 ...
 >
 <summary className="flex items-center justify-between px-5 py-4 cursor-pointer text-sm font-medium text-gray-700 hover:text-violet-300 transition list-none">
 {faq.q}
