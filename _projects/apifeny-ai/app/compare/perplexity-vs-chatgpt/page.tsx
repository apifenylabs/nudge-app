...
export default function PerplexityVsChatGPTCompare() {
 ...
 <div className="relative rounded-2xl bg-gradient-to-br from-violet-500/10 via-tech-800 to-pink-500/5 border border-tech-500/30 p-8 sm:p-12">
 ...
 key={item.href}
 href={item.href}
 className="flex items-center gap-2 text-sm text-tech-300 hover:text-violet-300 transition px-3 py-2 rounded-lg hover:bg-tech-700/40"
 >
 ...
 {/* Perplexity */}
 <div className="rounded-xl bg-tech-800/50 border border-violet-500/30 p-6">
 ...
 <p className="text-xs text-tech-400">Sonar / Sonar Pro</p>
 </div>
 </div>
 ...
 <p className="text-xs text-tech-400">GPT-4o / o3</p>
 </div>
 </div>
 <div className="space-y-2.5">
 ...
 <th className="text-left px-4 py-3 text-violet-300 font-semibold border-b border-tech-500/20 w-[30%]">
 Perplexity
 </th>
 ...
 <td className="px-4 py-3 text-tech-300">{row.perplexity}</td>
 ...
 <div
 key={uc.title}
 className="rounded-xl bg-tech-800/40 border border-tech-500/20 p-6 hover:border-violet-500/30 transition"
 >
 ...
 <div className="relative rounded-2xl bg-gradient-to-br from-violet-500/10 via-tech-800 to-pink-500/5 border border-tech-500/30 p-8 sm:p-10 overflow-hidden">
 ...
 <div className="rounded-xl bg-tech-800/60 border border-violet-500/20 p-5">
 ...
 <Link
 href="/compare"
 className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-tech-500/40 text-tech-200 hover:text-white hover:border-violet-500/40 text-sm font-medium transition"
 >
