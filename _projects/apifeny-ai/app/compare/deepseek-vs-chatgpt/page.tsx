...
export default function DeepSeekVsChatGPTCompare() {
 ...
 <div>
 <h3 className="text-lg font-bold text-white">DeepSeek</h3>
 <p className="text-xs text-tech-400">V3 / R1 — Open Source</p>
 </div>
 </div>
 ...
 <p className="text-xs text-tech-400">GPT-4o / o3 — Proprietary</p>
 </div>
 </div>
 <div className="space-y-2.5">
 ...
 <strong className="text-white">Tie</strong> on: reasoning
 </p>
 </div>
 </section>
 ...
 <td className="px-4 py-3 text-tech-300">{row.deepseek}</td>
 ...
 <Zap className="w-5 h-5 text-neon-light" />
 <h3 className="text-base font-bold text-white">Choose DeepSeek if you:</h3>
 </div>
