...
export default function CopilotVsWindsurfCompare() {
 ...
 <div className="relative rounded-2xl bg-gradient-to-br from-aqua/10 via-cyan-500/5 to-tech-800 border border-tech-500/30 p-8 sm:p-12">
 ...
 {/* Windsurf */}
 <div className="rounded-xl bg-tech-800/50 border border-cyan-500/30 p-6">
 <div className="flex items-center gap-3 mb-4">
 ...
 <p className="text-xs text-tech-400">Codeium Cascade · GPT-4o + Claude + Gemini</p>
 </div>
 </div>
 <div className="space-y-2.5">
 ...
 <th className="text-left px-4 py-3 text-cyan-400 font-semibold border-b border-tech-500/20 w-[30%]">
 Codeium Windsurf
 </th>
 ...
 <td className="px-4 py-3 text-tech-300">{row.windsurf}</td>
 ...
 <div className="relative rounded-2xl bg-gradient-to-br from-aqua/10 via-tech-800 to-cyan-500/5 border border-tech-500/30 p-8 sm:p-10 overflow-hidden">
 ...
 <div className="rounded-xl bg-tech-800/60 border border-cyan-500/20 p-5">
 <div className="flex items-center gap-2 mb-3">
 <Zap className="w-5 h-5 text-cyan-400" />
