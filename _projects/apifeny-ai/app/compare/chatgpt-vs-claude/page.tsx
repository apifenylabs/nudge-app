...
function ScoreBar({ score, label }: { score: number; label: string }) {
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="text-xs text-tech-400 w-20 shrink-0">{label}</span>
    ...
    <div className="min-h-screen bg-tech-900">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="relative mb-12">
          <div className="relative rounded-2xl bg-gradient-to-br from-aqua/10 via-neon/5 to-tech-800 border border-tech-500/30 p-8 sm:p-12">
            ...
            <div className="rounded-xl bg-tech-800/50 border border-neon/30 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-tech-400">Sonnet / Opus — Proprietary</p>
                </div>
              </div>
              <div className="space-y-2.5">
                ...
                <tbody className="divide-y divide-tech-500/10">
                  {section.items.map((row, i) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-tech-300">{row.claude}</td>
        ...
        <section id="recommendation" className="mb-12 scroll-mt-20">
          <div className="relative rounded-2xl bg-gradient-to-br from-aqua/10 via-tech-800 to-neon/5 border border-tech-500/30 p-8 sm:p-10 overflow-hidden">
