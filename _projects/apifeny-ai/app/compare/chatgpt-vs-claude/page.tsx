...
export default function ChatGPTVsClaudeCompare() {
 ...
 <strong className="text-gray-900">Tie</strong> on: writing quality, pricing
 </p>
 </div>
 </section>
 ...
 <div className="flex items-center gap-2 mb-3">
 <Zap className="w-5 h-5 text-neon-light" />
 <h3 className="text-base font-bold text-gray-900">Choose Claude if you:</h3>
 </div>
 <ul className="space-y-2">
 {[
 ...
 <h2 className="text-xl font-bold text-gray-900 mb-2">More AI comparisons</h2>
