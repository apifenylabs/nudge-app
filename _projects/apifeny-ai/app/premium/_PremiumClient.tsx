...
export default function PremiumPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-tech-900 to-gray-950">
      {/* Hero */}
      <section className="relative overflow-hidden pt-20 pb-16 sm:pt-28 sm:pb-20">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20 mb-6">
            ...
            <span className="text-xs font-medium text-amber-300">Apifeny Pro</span>
          </div>
          ...
          <p className="text-base sm:text-lg text-tech-200 max-w-2xl mx-auto mb-8 leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            ...
            <Link
              href="/playbooks"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-tech-700 hover:bg-tech-600 text-tech-100 text-sm font-semibold border border-tech-500/30 transition-all"
            >
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-10 text-center">
            <div>
              ...
              <div className="text-xs text-tech-400 mt-1">Playbooks</div>
            </div>
            <div className="w-px h-10 bg-tech-600 hidden sm:block" />
            <div>
              <div className="text-2xl sm:text-3xl font-bold text-white">300+</div>
              <div className="text-xs text-tech-400 mt-1">AI Prompts</div>
            </div>
            <div className="w-px h-10 bg-tech-600 hidden sm:block" />
            <div>
              <div className="text-2xl sm:text-3xl font-bold text-white">$9</div>
              <div className="text-xs text-tech-400 mt-1">Per Playbook or Free</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-tech-300 max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {FEATURES.map((feature) => (
              <div
                key={feature.title}
                className="rounded-xl border border-tech-600/30 bg-tech-800/40 p-5 hover:border-tech-500/50 hover:bg-tech-800/60 transition-all"
              >
                ...
                <p className="text-xs text-tech-300 leading-relaxed">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="plans" className="py-12 sm:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-tech-300 max-w-lg mx-auto">
              ...
              <div
                ...
                className={`rounded-xl border p-6 relative ${
                  plan.highlighted
                    ...
                    : 'border-tech-600/30 bg-tech-800/40'
                }`}
              >
                {plan.highlighted && (
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-baseline gap-1 mt-2">
                    ...
                    <span className="text-tech-400 text-sm">{plan.period}</span>
                  </div>
                  <p className="text-xs text-tech-400 mt-1">{plan.description}</p>
                </div>

                <ul className="space-y-2 mb-5">
                  {plan.features.map((feature) => (
                    <li key={feature} className="flex items-start gap-2 text-xs text-tech-200">
                ...
                <button
                  ...
                  className={`w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${
                    plan.highlighted
                      ...
                      : 'bg-tech-600 hover:bg-tech-500 text-white border border-tech-500/30'
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-tech-400 mb-3">
              Or buy individual playbooks starting at <span className="text-tech-200 font-semibold">$9</span> one-time
            </p>
            <Link
              href="/playbooks"
      ...
      <section className="pb-16 sm:pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="rounded-xl border border-tech-600/30 bg-tech-800/30 p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-left max-w-lg mx-auto">
              {GUARANTEES.map((g) => (
                <div key={g} className="flex items-start gap-2">
                  ...
                  <span className="text-xs text-tech-300">{g}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* CTA */}
          <div className="mt-8">
            <p className="text-xs text-tech-400 mb-3">Still exploring?</p>
            <div className="flex flex-wrap justify-center gap-3">
              <Link
                href="/playbooks"
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-tech-700 hover:bg-tech-600 text-tech-200 text-xs font-medium border border-tech-500/30 transition-all"
              >
