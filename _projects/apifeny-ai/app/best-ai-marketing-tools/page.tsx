...
export default function BestAIMarketingToolsPage() {
 ...
 <br />
 <span className="text-gray-800">Research, Content, Design &amp; Video</span>
 </h1>
 ...
 The complete AI marketing stack. From <strong className="text-gray-900">market research</strong> with Perplexity to{' '}
 <strong className="text-gray-900">content creation</strong> with Jasper, <strong className="text-gray-900">video production</strong> with
 Synthesia, and <strong className="text-gray-900">analytics</strong> — all ranked and compared.
 </p>
 ...
 <Link
 href="/tools"
 className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl border border-gray-200 text-gray-800 hover:border-emerald-400/30 hover:text-white text-sm sm:text-base font-medium transition-all"
 >
 ...
 <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-tech-500 to-tech-600 flex items-center justify-center shrink-0 border border-gray-200/30 group-hover:border-emerald-400/30 transition">
 <span className="text-gray-900 font-bold text-sm">
 {tool.name.split(' ').map((w) => w[0]).join('').slice(0, 2).toUpperCase()}
 </span>
 </div>
 <div className="min-w-0 flex-1">
 <h3 className="text-base font-semibold text-gray-900 truncate group-hover:text-emerald-300 transition-colors">{tool.name}</h3>
 ...
 return (
 <section key={stage.name} className="border-t border-gray-200 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
 ...
 <div>
 <h2 className="text-xl sm:text-2xl font-bold text-gray-900">{stage.name}</h2>
 <p className="text-sm text-gray-700 mt-1 max-w-xl">{stage.description}</p>
 </div>
 </div>
 ...
 className="group block rounded-xl border border-gray-200 bg-white p-4 transition-all duration-300 hover:border-emerald-400/30 hover:bg-white hover:-translate-y-0.5">
 ...
 <div className="min-w-0 flex-1">
 <h3 className="text-sm font-semibold text-gray-900 truncate group-hover:text-emerald-300 transition">{tool.name}</h3>
 ...
 <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Quick Comparison: Top Marketing AI Tools</h2>
 ...
 <th className="px-4 py-3 text-xs font-semibold text-gray-700 uppercase tracking-wider">Stage</th>
 ...
 <th className="px-4 py-3 text-xs font-semibold text-gray-700 uppercase tracking-wider">Asia</th>
 ...
 <td className="px-4 py-3 text-xs">{tool.asia_ready ? <span className="text-emerald-400">✓</span> : <span className="text-gray-400">—</span>}</td>
 <td className="px-4 py-3 text-xs">{tool.is_agentic ? <span className="text-sky-400">✓</span> : <span className="text-gray-400">—</span>}</td>
 </tr>
 ))}
 </tbody>
 </table>
 ...
 <div>
 <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Marketing Playbook</h2>
 <p className="text-xs sm:text-sm text-gray-700">Follow this guide to build your AI-powered marketing workflow.</p>
 </div>
 </div>

 <Link
 href={`/playbook/${marketingPlaybook.slug}`}
 className="block rounded-xl border border-gray-200 bg-white p-6 hover:border-emerald-400/30 hover:-translate-y-0.5 transition-all"
 >
 <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
 <div>
 <h3 className="text-lg font-semibold text-gray-900">{marketingPlaybook.title}</h3>
 <p className="text-sm text-gray-700 mt-1">{typeof marketingPlaybook.description === 'string' ? marketingPlaybook.description : ''}</p>
 </div>
