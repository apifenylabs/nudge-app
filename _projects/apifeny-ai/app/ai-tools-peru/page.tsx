        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
          <div className="text-center">
            <p className="text-[10px] text-tech-400 leading-loose max-w-3xl mx-auto">
              ...
              AI tools Peru, best AI tools Peru 2026, Peru AI directory, AI for Peruvian businesses, Lima AI startups, AI tools Spanish, Peru machine learning, AI fintech Peru, mining AI Peru, AI agritech PeruCanadian tech stack · 
