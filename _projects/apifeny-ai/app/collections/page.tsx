...
export default function CollectionsPage() {
 ...
 <div className="relative rounded-2xl bg-gradient-to-br from-aqua/10 via-tech-800 to-neon/5 border border-gray-200 p-8 sm:p-12">
 ...
 className={`group relative rounded-xl bg-gradient-to-br ${col.gradient} bg-gray-50 border border-gray-200 p-5 hover:border-neon/40 transition-all hover:-translate-y-1 overflow-hidden`}
 >
