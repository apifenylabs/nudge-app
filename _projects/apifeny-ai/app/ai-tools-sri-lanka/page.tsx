...
export default function AiToolsSriLankaPage() {
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-white via-amber-50/30 to-white dark:from-gray-950 dark:via-amber-950/10 dark:to-gray-950">
        {/* ── Hero ─────────────────────────────────────── */}
        <section className="relative overflow-hidden border-b border-amber-100/50 dark:border-amber-900/20">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(200,16,46,0.06),transparent_50%)] dark:bg-[radial-gradient(ellipse_at_top_right,rgba(200,16,46,0.08),transparent_50%)] pointer-events-none" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(255,183,77,0.04),transparent_50%)] dark:bg-[radial-gradient(ellipse_at_bottom_left,rgba(255,183,77,0.06),transparent_50%)] pointer-events-none" />
          <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 relative">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-4 py-1.5 text-sm font-medium text-[#C8102E] dark:border-amber-800 dark:bg-amber-950/50 dark:text-amber-300">
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                <a
                  href="#top-picks"
                  className="inline-flex items-center gap-2 rounded-xl bg-[#C8102E] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-amber-200/50 transition-all hover:bg-[#A00D25] hover:shadow-amber-300/50 dark:shadow-amber-900/30"
                >
          ...
          <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {TRUST_SECTIONS.map((s) => (
                <div
                  key={s.title}
                  className="rounded-xl border border-amber-100/60 bg-white/80 p-5 shadow-sm transition-all hover:shadow-md dark:border-amber-900/30 dark:bg-gray-900/80"
                >
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {LK_AI_SNAPSHOT.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-xl border border-amber-100/60 bg-white p-6 text-center shadow-sm dark:border-amber-900/30 dark:bg-gray-900"
                >
                  <p className="text-3xl font-bold text-[#C8102E] dark:text-amber-400">{stat.value}</p>
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {WHY_LK.map((item) => (
                <div
                  key={item.title}
                  className="group relative rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-[#C8102E]/30 hover:shadow-md dark:border-gray-800 dark:bg-gray-900/50 dark:hover:border-[#C8102E]/40"
                >
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-[#C8102E]/10 text-[#C8102E] dark:bg-amber-900/30 dark:text-amber-400">
              ...
              {ALL_CATEGORIES.map((cat) => (
                <div key={cat.id} id={cat.id}>
                  <div className="mb-6 flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#C8102E]/10 text-[#C8102E] dark:bg-amber-900/30 dark:text-amber-400">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {cat.tools.map((tool) => (
                      <div
                        key={tool.name}
                        className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-[#C8102E]/20 hover:shadow-md dark:border-gray-800 dark:bg-gray-900/50"
                      >
                        <span className="inline-block rounded-full bg-[#C8102E]/10 px-2.5 py-0.5 text-xs font-medium text-[#C8102E] dark:bg-amber-900/40 dark:text-amber-300">
                          {tool.tag}
                        </span>
