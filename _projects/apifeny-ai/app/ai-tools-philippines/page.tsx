...
export default function AiToolsPhilippinesPage() {
 ...
 <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(0,56,168,0.06),transparent_50%)] ,rgba(0,56,168,0.08),transparent_50%)] pointer-events-none" />
 <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(206,17,38,0.04),transparent_50%)] ,rgba(206,17,38,0.06),transparent_50%)] pointer-events-none" />
 ...
 <a
 href="#top-picks"
 className="inline-flex items-center gap-2 rounded-xl bg-[#0038A8] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-200/50 transition-all hover:bg-[#002a7f] hover:shadow-blue-300/50 "
 >
 ...
 >
 <p className="text-3xl font-bold text-[#0038A8] ">{stat.value}</p>
 ...
 >
 <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-[#0038A8]/10 text-[#0038A8] ">
 ...
 <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0038A8]/10 text-[#0038A8] ">
 ...
 <div
 key={tool.name}
 className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-[#0038A8]/20 hover:shadow-md "
 >
 <span className="inline-block rounded-full bg-[#0038A8]/10 px-2.5 py-0.5 text-xs font-medium text-[#0038A8] ">
 {tool.tag}
 </span>
