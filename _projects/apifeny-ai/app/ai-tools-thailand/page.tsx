...
export default function AiToolsThailandPage() {
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-white via-purple-50/30 to-white dark:from-gray-950 dark:via-purple-950/10 dark:to-gray-950">
        {/* ── Hero ─────────────────────────────────────── */}
        <section className="relative overflow-hidden border-b border-purple-100/50 dark:border-purple-900/20">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(45,42,157,0.06),transparent_50%)] dark:bg-[radial-gradient(ellipse_at_top_right,rgba(45,42,157,0.08),transparent_50%)] pointer-events-none" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(237,27,36,0.04),transparent_50%)] dark:bg-[radial-gradient(ellipse_at_bottom_left,rgba(237,27,36,0.06),transparent_50%)] pointer-events-none" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.03),transparent_60%)] dark:bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.02),transparent_60%)] pointer-events-none" />
          <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 relative">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                <a
                  href="#top-picks"
                  className="inline-flex items-center gap-2 rounded-xl bg-[#2D2A9D] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-purple-200/50 transition-all hover:bg-[#1f1d6e] hover:shadow-purple-300/50 dark:shadow-purple-900/30"
                >
          ...
          <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {TRUST_SECTIONS.map((s) => (
                <div
                  key={s.title}
                  className="rounded-xl border border-purple-100/60 bg-white/80 p-5 shadow-sm transition-all hover:shadow-md dark:border-purple-900/30 dark:bg-gray-900/80"
                >
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {TH_AI_SNAPSHOT.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-xl border border-purple-100/60 bg-white p-6 text-center shadow-sm dark:border-purple-900/30 dark:bg-gray-900"
                >
                  <p className="text-3xl font-bold text-[#2D2A9D] dark:text-purple-400">{stat.value}</p>
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {WHY_TH.map((item) => (
                <div
                  key={item.title}
                  className="group relative rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-[#ED1B24]/30 hover:shadow-md dark:border-gray-800 dark:bg-gray-900/50 dark:hover:border-[#ED1B24]/40"
                >
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-[#2D2A9D]/10 text-[#2D2A9D] dark:bg-purple-900/30 dark:text-purple-400">
              ...
              {ALL_CATEGORIES.map((cat) => (
                <div key={cat.id} id={cat.id}>
                  <div className="mb-6 flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#2D2A9D]/10 text-[#2D2A9D] dark:bg-purple-900/30 dark:text-purple-400">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {cat.tools.map((tool) => (
                      <div
                        key={tool.name}
                        className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-[#2D2A9D]/20 hover:shadow-md dark:border-gray-800 dark:bg-gray-900/50"
                      >
                        <span className="inline-block rounded-full bg-[#2D2A9D]/10 px-2.5 py-0.5 text-xs font-medium text-[#2D2A9D] dark:bg-purple-900/40 dark:text-purple-300">
                          {tool.tag}
                        </span>
