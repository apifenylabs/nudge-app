...
const builds: BuildEntry[] = [
  ...
  },
  {
    ...
    description: 'Added 4 expert-crafted playbooks covering multi-agent architectures, AI QA testing pipelines, monetization from $0 to $1K MRR, and voice-first app building. Total playbook library now at 84 guides across all pipeline stages.',
    type: 'feature',
    stats: ['4 new expert playbooks', '84 total playbooks', 'New stages: build, review, deployment, content', '13-sample prompt library'],
  },
  {
    date: '2026-05-13',
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-16">
          {[
            ...
            { label: 'Total Playbooks', value: '84', icon: Layers },
