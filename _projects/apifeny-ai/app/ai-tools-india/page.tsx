...
export default function AiToolsIndiaPage() {
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-white via-orange-50/30 to-white dark:from-gray-950 dark:via-orange-950/10 dark:to-gray-950">
        {/* ── Hero ─────────────────────────────────────── */}
        <section className="relative overflow-hidden border-b border-orange-100/50 dark:border-orange-900/20">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(255,153,51,0.06),transparent_50%)] dark:bg-[radial-gradient(ellipse_at_top_right,rgba(255,153,51,0.08),transparent_50%)] pointer-events-none" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(0,102,51,0.04),transparent_50%)] dark:bg-[radial-gradient(ellipse_at_bottom_left,rgba(0,102,51,0.06),transparent_50%)] pointer-events-none" />
          <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 relative">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-orange-200 bg-orange-50 px-4 py-1.5 text-sm font-medium text-[#FF9933] dark:border-orange-800 dark:bg-orange-950/50 dark:text-orange-300">
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                <a
                  href="#top-picks"
                  className="inline-flex items-center gap-2 rounded-xl bg-[#FF9933] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-orange-200/50 transition-all hover:bg-[#E68A2E] hover:shadow-orange-300/50 dark:shadow-orange-900/30"
                >
          ...
          <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {TRUST_SECTIONS.map((s) => (
                <div
                  key={s.title}
                  className="rounded-xl border border-orange-100/60 bg-white/80 p-5 shadow-sm transition-all hover:shadow-md dark:border-orange-900/30 dark:bg-gray-900/80"
                >
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {IN_AI_SNAPSHOT.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-xl border border-orange-100/60 bg-white p-6 text-center shadow-sm dark:border-orange-900/30 dark:bg-gray-900"
                >
                  <p className="text-3xl font-bold text-[#FF9933] dark:text-orange-400">{stat.value}</p>
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {WHY_IN.map((item) => (
                <div
                  key={item.title}
                  className="group relative rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-[#FF9933]/30 hover:shadow-md dark:border-gray-800 dark:bg-gray-900/50 dark:hover:border-[#FF9933]/40"
                >
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-[#FF9933]/10 text-[#FF9933] dark:bg-orange-900/30 dark:text-orange-400">
              ...
              {ALL_CATEGORIES.map((cat) => (
                <div key={cat.id} id={cat.id}>
                  <div className="mb-6 flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#FF9933]/10 text-[#FF9933] dark:bg-orange-900/30 dark:text-orange-400">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {cat.tools.map((tool) => (
                      <div
                        key={tool.name}
                        className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-[#FF9933]/20 hover:shadow-md dark:border-gray-800 dark:bg-gray-900/50"
                      >
                        <span className="inline-block rounded-full bg-[#FF9933]/10 px-2.5 py-0.5 text-xs font-medium text-[#FF9933] dark:bg-orange-900/40 dark:text-orange-300">
                          {tool.tag}
                        </span>
