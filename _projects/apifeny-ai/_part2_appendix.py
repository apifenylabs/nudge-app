# PART2_CONTENT_START
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            <strong className="text-gray-900">Key AI features:</strong> AI-powered ETA prediction across all transport modes (ocean, air, rail, truck); predictive disruption alerts with root cause analysis; AI-driven detention and demerage management; automated exception handling and workflow triggers; ML-based carrier performance scoring.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
