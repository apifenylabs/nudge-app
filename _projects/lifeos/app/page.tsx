          ...
          <div className="max-w-3xl w-full">
            ...
            <div className="mb-6 flex items-center justify-center">
              <button
                ...
                className="group px-5 py-3 rounded-xl bg-gradient-to-r from-teal-50 to-emerald-50 border border-teal-200 hover:border-teal-300 hover:shadow-md hover:shadow-teal-200/40 transition-all duration-300 text-sm font-medium text-teal-700 flex items-center gap-2 w-full justify-center"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <span>🦊 Weekly Digest</span>
                <svg className="w-3.5 h-3.5 text-teal-400 group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </button>
            </div>
            ...
            {/* Weekly Digest Modal */}
            {showDigest && (
              <WeeklyDigestModal onClose={() => setShowDigest(false)} />
            )}
