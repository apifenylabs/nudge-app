        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mt-5 pt-5 border-t border-gold/10">
            ...
            <div className="flex flex-wrap justify-center gap-3 text-xs">
              <a href="https://www.booking.com/searchresults.html?ss=Asia+Family&aid=2875669" target="_blank" rel="noopener noreferrer nofollow sponsored" className="px-3 py-1.5 rounded-full border border-gold/20 text-cream/50 hover:text-gold hover:border-gold/40 transition-all">
                🏨 Hotels
              </a>
              <a href="https://www.klook.com/?aid=119991" target="_blank" rel="noopener noreferrer nofollow sponsored" className="px-3 py-1.5 rounded-full border border-gold/20 text-cream/50 hover:text-gold hover:border-gold/40 transition-all">
                🎫 Activities
              </a>
              <a href="https://www.viator.com/Asia/d11-ttd?aid=P00299136" target="_blank" rel="noopener noreferrer nofollow sponsored" className="px-3 py-1.5 rounded-full border border-gold/20 text-cream/50 hover:text-gold hover:border-gold/40 transition-all">
                🏛️ Tours
              </a>
              <a href="https://www.getyourguide.com/asia-l33/?partner_id=GUIDE" target="_blank" rel="noopener noreferrer nofollow" className="px-3 py-1.5 rounded-full border border-gold/20 text-cream/50 hover:text-gold hover:border-gold/40 transition-all">
                🌟 Experiences
              </a>
              <a href="https://www.expedia.com/?ttv=2&mctc=10" target="_blank" rel="noopener noreferrer nofollow sponsored" className="px-3 py-1.5 rounded-full border border-gold/20 text-cream/50 hover:text-gold hover:border-gold/40 transition-all">
                🚗 Car Rental
              </a>
            </div>
          </div>
