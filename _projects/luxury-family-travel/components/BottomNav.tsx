...
function AiIcon({ active }: { active: boolean }) {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? '#7C3AED' : '#6b7280'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2a10 10 0 0 1 7.07 17.07A10 10 0 0 1 12 22a10 10 0 0 1-7.07-2.93A10 10 0 0 1 12 2z" />
      <path d="M12 6v6l4 2" />
...
const navItems = [
  ...
  { href: 'https://apifeny-ai.vercel.app', label: 'AI Tools', icon: AiIcon, external: true },
];
