    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl border border-gray-200 p-8 md:p-10 shadow-sm space-y-8">
          ...
          {/* Usage Data & Ecosystem Improvement */}
          <div className="flex items-start gap-3">
            <Info size={18} className="text-sky-500 mt-0.5 shrink-0" />
            <div>
              <h2 className="text-lg font-bold text-gray-900 mb-2">Usage Data &amp; Ecosystem Improvement</h2>
              ...
              <p className="text-gray-600 mb-2">
                ...
                out at any time via the toggle in the bottom-right corner of any page.
              </p>
              <p className="text-gray-600">
