            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {deals.map((deal) => {
                ...
                return (
                  <div
                    key={deal.id}
                    className="bg-white rounded-xl border border-gray-200 hover:shadow-md hover:border-sky-200 transition-all p-4 group"
                  >
                    {/* Badge */}
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer sponsored"
                        className="inline-flex items-center gap-1 px-3 py-1.5 bg-sky-600 hover:bg-sky-700 text-white text-xs font-medium rounded-lg transition-all"
                      >
