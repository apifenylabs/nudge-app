      ...
      <div className="space-y-4">
        {shown.map((partner) => {
          ...
          return (
            <div
              key={partner.id}
              className={`${cfg.bg} border ${cfg.border} rounded-xl p-5 hover:shadow-sm transition-all`}
            >
              {/* Partner header */}
              <div className="flex items-start justify-between gap-4 mb-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer sponsored"
                  className="shrink-0 inline-flex items-center gap-1.5 px-4 py-2 bg-gray-900 hover:bg-gray-800 text-white text-xs font-medium rounded-lg transition-all"
                >
